...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AtSomeonePageModule", function() { return AtSomeonePageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__at_someone__ = __webpack_require__(1215);
...
var AtSomeonePageModule = (function () {
    function AtSomeonePageModule() {
    }
    AtSomeonePageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__at_someone__["a" /* AtSomeonePage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["k" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__at_someone__["a" /* AtSomeonePage */]),
                __WEBPACK_IMPORTED_MODULE_4__pipes_pipes_module__["a" /* PipesModule */],
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */],
            ],
        })
    ], AtSomeonePageModule);
    return AtSomeonePageModule;
}());

//# sourceMappingURL=at-someone.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return AtSomeonePage; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_alpha_list_alpha_list__ = __webpack_require__(1122);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/**
 * Generated class for the AtSomeonePage page.
 *
 * See https://ionicframework.com/docs/components/#navigation for more info on
 * Ionic pages and navigation.
 */
var AtSomeonePage = (function () {
    function AtSomeonePage(navCtrl, viewCtrl, contactProvider, events, navParams) {
        this.navCtrl = navCtrl;
        ...
        this.items = [];
        this.isFilter = false;
        this.data = this.contactProvider.getContacts();
        this.getContact();
    }
    AtSomeonePage.prototype.ionViewDidLoad = function () {
        console.log('ionViewDidLoad AtSomeonePage');
    };
    AtSomeonePage.prototype.getCurrentItems = function (ev) {
        if (!this.searchText) {
        ...
        if (val && val.trim() != '') {
            this.searchItems = this.allItems.filter(function (item) {
                //return this.filterName(val,item.remark)
            });
        }
    };
    AtSomeonePage.prototype.filterName = function (searchValue, itemName) {
        var LoweritemName = itemName.toLowerCase();
        var LowersearchValue = searchValue.toLowerCase();
        // let CamelChars = pinyin.getCamelChars(itemName)
        // if(LoweritemName.indexOf(LowersearchValue) > -1 ||
        // CamelChars.toLowerCase().indexOf(LowersearchValue) > -1){
        //   return true;
        // }
        // for(let item of itemName.split('')){
        //   // let fullchars = pinyin.getFullChars(item);
    ...
    AtSomeonePage.prototype.onClearFilter = function (ev) {
        this.isFilter = false;
    };
    AtSomeonePage.prototype.getContact = function () {
        var _this = this;
    ...
    AtSomeonePage.prototype.itemSelected1 = function (item) {
        this.viewCtrl.dismiss();
        this.events.publish('at-someone:choosen', item);
    };
    AtSomeonePage.prototype.itemSelected = function (contact) {
        this.viewCtrl.dismiss();
        this.events.publish('at-someone:choosen', contact);
    };
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["ViewChild"])(__WEBPACK_IMPORTED_MODULE_4__components_alpha_list_alpha_list__["a" /* AlphaListComponent */]),
        __metadata("design:type", __WEBPACK_IMPORTED_MODULE_4__components_alpha_list_alpha_list__["a" /* AlphaListComponent */])
    ], AtSomeonePage.prototype, "alist", void 0);
    AtSomeonePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["Component"])({
            selector: 'page-at-someone',template:/*ion-inline-start:"F:\iproud2.5-pwa\src\pages\community\at-someone\at-someone.html"*/'<!--\n\n  Generated template for the AtSomeonePage page.\n\n\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n\n  Ionic pages and navigation.\n\n-->\n\n<ion-header>\n\n\n\n  <ion-navbar>\n\n    <ion-title>at-someone</ion-title>\n\n  </ion-navbar>\n\n\n\n</ion-header>\n\n\n\n\n\n<ion-content >\n\n    <div top>\n\n        <ion-searchbar [(ngModel)]="searchText" (ionInput)="getCurrentItems($event)" (ionClear)="onClearFilter($event)" placeholder="搜索"></ion-searchbar> \n\n    </div>\n\n    <ion-alpha-list   *ngIf="!isFilter">\n\n    <ng-container *ngFor="let i of data">\n\n        <ion-alpha-section [index]="i.id">\n\n          <ng-container *ngFor="let contact of i.items">\n\n            <ion-alpha-cell>\n\n              <ion-item (click)="itemSelected(contact)">\n\n                <ion-avatar item-start>\n\n                  <img [src]="contact.avatar" class="img"/>\n\n                </ion-avatar>\n\n                <ion-label>\n\n                  <h2>{{contact.remark}}</h2>\n\n                  <!--<p *ngIf="contact.duty">{{contact.duty}}</p>-->\n\n                </ion-label>\n\n              </ion-item>\n\n            </ion-alpha-cell>\n\n          </ng-container>\n\n        </ion-alpha-section>\n\n      </ng-container>\n\n    </ion-alpha-list>\n\n    <div *ngIf="isFilter">\n\n      <ion-list no-lines="true">\n\n        <ion-item *ngFor="let item of searchItems" class="search-item" (click)="itemSelected1(item)">\n\n          <div item-start>\n\n            <img class="img" src="{{item.avatar}}" />\n\n          </div>\n\n          <ion-label [innerHTML]="item.remark "></ion-label>\n\n        </ion-item>\n\n      </ion-list>\n\n    </div>\n\n\n\n</ion-content>\n\n'/*ion-inline-end:"F:\iproud2.5-pwa\src\pages\community\at-someone\at-someone.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2_ionic_angular__["p" /* NavController */],
    ...
    return AtSomeonePage;
}());

//# sourceMappingURL=at-someone.js.map
