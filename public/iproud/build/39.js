...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__login__ = __webpack_require__(1175);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__providers_config_provider__ = __webpack_require__(593);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_ionic_angular__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__ngx_translate_core__ = __webpack_require__(29);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_ionic_angular_components_action_sheet_action_sheet_controller__ = __webpack_require__(215);
...
var LoginPage = (function () {
    function LoginPage(navCtrl, modalCtrl, authProvider, translateService, actionSheetCtrl, session, events, http, nativeService, storageService, loadingCtrl, countryProvider, ionicApp, ViewCtrl, configProvider, httpService) {
        var _this = this;
        this.navCtrl = navCtrl;
        ...
        this.languages = __WEBPACK_IMPORTED_MODULE_9__services_constants__["u" /* LANGUAGES */];
        this.loginEnabled = false;
        this.isShowWechat = true;
        this.validateInput();
        this.events.subscribe('Login2:success', function (resp) {
            _this.loginSuccess(resp);
        });
        this.events.subscribe('extra-login-success', function () {
            _this.closeThisWindow();
        });
        this.storageService.getItem("mobilephone").then(function (mobilephone) {
            _this.account.mobilephone = mobilephone;
        });
        this.storageService.getItem("country").then(function (country) {
            if (country != null && country != undefined) {
                _this.account.country = country;
            }
            else {
                // this.account.country = "+86";
                _this.nativeService.getSimInfo().subscribe(function (info) {
                    if (info.countryCode) {
    ...
    LoginPage.prototype.ionViewDidLoad = function () {
        ...
        // this.events.subscribe('wechat-auth', (resp) => {
        //   this.getWechatUserInfo(resp)
        // })
    };
    LoginPage.prototype.ionViewWillUnload = function () {
        this.events.unsubscribe('wechat-auth');
    };
    // Attempt to login in through our User service
    LoginPage.prototype.doLogin = function () {
        this.loginEnabled = false;
        this.LoginByMobileBefore();
    };
    /**
     * 验证输入
     */
    LoginPage.prototype.validateInput = function () {
        if (this.account.mobilephone.length > 0 && this.account.password.length > 0) {
     ...
     * 登录前先进行验证码校验
     */
    LoginPage.prototype.LoginByMobileBefore = function () {
        var _this = this;
        var accountInfo = {
            "mobilePhone": this.account.country + " " + this.account.mobilephone,
            "password": this.account.password,
            "lang": this.session.language
        };
        accountInfo['clientId'] = this.account.country + " " + this.account.mobilephone,
            this.authProvider.sendSecurityCodeBefore('LoginByMobileBefore', accountInfo, '', function () {
                _this.loginEnabled = true;
            });
    };
    LoginPage.prototype.loginSuccess = function (resp) {
        this.storageService.setItem("mobilephone", this.account.mobilephone);
        this.storageService.setItem("country", this.account.country);
    ...
    LoginPage.prototype.doForgotPassword = function () {
        this.modalCtrl.create('ForgotPasswordPage', {
            mobile: this.account.mobilephone
        }).present();
     ...
     * workflow账号登录
     */
    LoginPage.prototype.goWorkflowLogin = function () {
        // this.navCtrl.push('WfLoginPage');
        this.modalCtrl.create('WfLoginPage').present();
    };
    /**
     * 选择地区
     */
    LoginPage.prototype.doSelectCountry = function () {
        var _this = this;
        var selectModal = this.modalCtrl.create('SelectCountryPage', { isNeedAll: true });
     ...
     * 打开语言选择
     */
    LoginPage.prototype.doSelectLanguage = function () {
        var _this = this;
        ...
        var this_1 = this;
        for (var _i = 0, LANGUAGES_1 = __WEBPACK_IMPORTED_MODULE_9__services_constants__["u" /* LANGUAGES */]; _i < LANGUAGES_1.length; _i++) {
        ...
        this.actionSheetCtrl.create({
            title: this.translateService.instant('LOGIN_LANGUAGE_SELECT'),
            buttons: ActionSheetButtons
        }).present();
    };
    /**选定语言 */
    LoginPage.prototype._selectLanguage = function (lang) {
        this.language = lang;
     ...
     * 关闭当前页面
     */
    LoginPage.prototype.closeThisWindow = function () {
        this.ViewCtrl.dismiss();
        if (location.href.split('/').pop().indexOf('my-list') > -1) {
            this.events.publish('to-homemain');
        }
    };
    LoginPage.prototype.WeChatAuth = function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        this.authProvider.LoginByWechat(code).subscribe(function (res) {
                            _this.authProvider.loginSuccessHandle(res);
                            _this.loginSuccess(res);
                        }, function (err) {
                            var msg = _this.translateService.instant('LOGIN_ERROR');
                            if (err.errcode === 6008) {
                                _this.session.unionId = err.result && err.result.unionId;
                                msg = _this.translateService.instant('LOGIN_ERROR_CODE_6008');
                            }
                            else if (err.errcode === 6006) {
                                msg = _this.translateService.instant('LOGIN_ERROR_CODE_6006');
                            }
                            _this.nativeService.alert(msg);
                        }, function () {
    ...
    LoginPage.prototype.getWechatUserInfo = function (response) {
        var _this = this;
        alert('step 1 response:' + JSON.stringify(response));
        var grant_type = 'authorization_code';
        var code = response.code;
        var getTokenUrl = "https://api.weixin.qq.com/sns/oauth2/access_token?appid=" + __WEBPACK_IMPORTED_MODULE_9__services_constants__["G" /* WEIXIN_APPID */] + "&secret=" + __WEBPACK_IMPORTED_MODULE_9__services_constants__["H" /* WEIXIN_APPSECRET */] + "&code=" + code + "&grant_type=" + grant_type;
        alert("getTokenUrl:" + getTokenUrl);
        this.httpService.get(getTokenUrl).subscribe(function (res) {
            if (res.errcode == 0) {
                ...
                alert("getUserUrl:" + getUserUrl);
                _this.httpService.get(getUserUrl).subscribe(function (userInfoResponse) {
            ...
            alert('http :' + JSON.stringify(res));
        });
    };
    LoginPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_3__angular_core__["Component"])({
            selector: 'page-login',template:/*ion-inline-start:"F:\iproud2.5-pwa\src\pages\account\login\login.html"*/'<ion-header >\n\n  <ion-navbar  >\n\n    <ion-buttons start>\n\n      <button ion-button color="royal" (click)="doSelectLanguage()">\n\n        <ion-icon name="globe-outline"></ion-icon>\n\n        &nbsp;{{\'LOGIN_LANGUAGES\'|translate}}\n\n      </button>\n\n    </ion-buttons>\n\n    <!-- <ion-title>{{ \'LOGIN_TITLE\' | translate }}</ion-title> -->\n\n    <ion-buttons end>\n\n      <button ion-button (click)="register()">\n\n        {{ \'LOGIN_REGISTER\' | translate }}\n\n      </button>\n\n    </ion-buttons>\n\n  </ion-navbar>\n\n</ion-header>\n\n<ion-content>\n\n  <div class="splash-bg">\n\n  </div>\n\n  <div class="splash-info">\n\n    <div class="splash-logo">{{ \'WELCOME_TITLE\' | translate }}</div>\n\n    <div class="splash-intro">\n\n      {{ \'WELCOME_INTRO\' | translate }}\n\n    </div>\n\n  </div>\n\n \n\n\n\n<form (submit)="doLogin()"  action="javascript:return true">\n\n  <ion-grid  class="mobile">\n\n\n\n    <ion-row>\n\n      <ion-col col-3 class="line_label selectcountry" text-right>\n\n        <button type="button" ion-button outline clear icon-right (click)="doSelectCountry()">{{account.country}}\n\n          <ion-icon name="md-arrow-dropdown"></ion-icon>\n\n        </button>\n\n      </ion-col>\n\n      <ion-col col-9 class="line_input"  >\n\n        <ion-input type="text" name="mobilephone" placeholder="{{ \'LOGIN_MOBILEPHONE\' | translate }}" [(ngModel)]="account.mobilephone" (ngModelChange)="validateInput()">  </ion-input>\n\n      </ion-col>\n\n    </ion-row>\n\n  </ion-grid>\n\n\n\n   \n\n  <ion-grid  class="password">\n\n    <ion-row >\n\n      <ion-col col-12 class="line_input"  >\n\n        <ion-input type="password" [(ngModel)]="account.password"  (ngModelChange)="validateInput()" name="password" placeholder="{{ \'LOGIN_PASSWORD_HINTS\' | translate }}"></ion-input>\n\n      </ion-col>\n\n    </ion-row>\n\n  </ion-grid>\n\n\n\n   \n\n  <ion-grid>\n\n    <ion-row>\n\n      <ion-col text-center col-6 class="other_label" (click)="goWorkflowLogin()" > \n\n        <button type="button" ion-button  outline block  >{{ \'LOGIN_WORKFLOW\' |   translate }}{{ \'LOGIN_SUBMIT\' |   translate }} </button> \n\n      </ion-col>\n\n      <ion-col col-6 class="line_label">\n\n        <button type="submit"  [disabled]="!loginEnabled" ion-button color="primary"  block>{{ \'LOGIN_SUBMIT\' | translate }} </button>\n\n      </ion-col>\n\n    </ion-row>\n\n  </ion-grid>\n\n</form>\n\n\n\n  <ion-grid class="login-other" *ngIf="isShowWechat">\n\n    <span class="login-other-text"  >{{\'LOGIN_FORGOT_PASSWORD\'| translate}}\n\n       <a href="#" (click)="doForgotPassword()">{{\'LOGIN_RETRIEVE_PASSWORD\' | translate}}</a></span>\n\n    <ion-row>          \n\n    </ion-row>\n\n  </ion-grid>\n\n\n\n  <privacy-policy float="true" agreeText="{{ \'SIGNUP_LOGIN_AGREE_PRIVACY\' | translate }}" language="{{language}}"></privacy-policy>\n\n\n\n  <!-- </form> -->\n\n\n\n</ion-content>\n\n'/*ion-inline-end:"F:\iproud2.5-pwa\src\pages\account\login\login.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2_ionic_angular__["p" /* NavController */],
            __WEBPACK_IMPORTED_MODULE_2_ionic_angular__["n" /* ModalController */],
            ...
            __WEBPACK_IMPORTED_MODULE_1__providers_config_provider__["a" /* ConfigProvider */],
