...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ContactAddPageModule", function() { return ContactAddPageModule; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__contact_add__ = __webpack_require__(1243);
...
var ContactAddPageModule = (function () {
    function ContactAddPageModule() {
    }
    ContactAddPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_3__contact_add__["a" /* ContactAddPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_2_ionic_angular__["k" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_3__contact_add__["a" /* ContactAddPage */]),
                __WEBPACK_IMPORTED_MODULE_4__ngx_translate_core__["b" /* TranslateModule */],
                __WEBPACK_IMPORTED_MODULE_0__components_components_module__["a" /* ComponentsModule */]
            ],
        })
    ], ContactAddPageModule);
    return ContactAddPageModule;
}());

//# sourceMappingURL=contact-add.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ContactAddPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_common_http__ = __webpack_require__(47);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__ngx_translate_http_loader__ = __webpack_require__(221);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__ngx_translate_core__ = __webpack_require__(29);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_message_provider__ = __webpack_require__(123);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_contact_provider__ = __webpack_require__(213);
...
var ContactAddPage = (function () {
    function ContactAddPage(http, navCtrl, navParams, contactProvider, alertCtrl, events, messageProvider, translate) {
        this.http = http;
        this.navCtrl = navCtrl;
        ...
        this.searchKey = '';
        this.contacts = [];
        this.latestFriends = this.navParams.data.latestFriends;
    }
    ;
    ContactAddPage.prototype.ionViewDidLoad = function () {
        var _this = this;
        this.events.subscribe('contact:refresh-newFriends', function () {
            _this.LatestFriendRequest();
        });
    };
    ContactAddPage.prototype.ionViewWillUnload = function () {
        //console.log('界面销毁'); 
        this.events.unsubscribe('contact:refresh-newFriends');
    };
    ContactAddPage.prototype.doAgreeAddRequest = function (contact) {
        this.AcceptAddRequest(contact.id, true);
    };
    ContactAddPage.prototype.doRejectAddRequest = function (contact) {
        this.AcceptAddRequest(contact.id, false);
    };
    ContactAddPage.prototype.AcceptAddRequest = function (requestId, isAccpet) {
        var _this = this;
        event.stopPropagation();
        this.contactProvider.AcceptAddRequest(requestId, isAccpet).subscribe(function (res) {
            _this.LatestFriendRequest();
            if (isAccpet) {
                setTimeout(function () {
                    ...
                    // 同意请求后发送通知给好友
                    if (res && res.result) {
                        var lang = res.result.lang || 'zh-CN';
                        var messageData_1 = {
                            widgetId: res.result.friendId,
                            id: Date.now() + Math.floor((Math.random() * 1000)),
                            imageUrl: "",
                            abstract: _this.translate.instant('CONTACT_ADD_SEND_RESPONSE'),
                            formatType: 'Text',
                            isRead: true,
                            isSend: true,
                            status: 'unsend',
                        ...
                        _this.translate.currentLoader = new __WEBPACK_IMPORTED_MODULE_1__ngx_translate_http_loader__["a" /* TranslateHttpLoader */](_this.http, './assets/i18n/', '.json');
                        _this.translate.getTranslation(lang).subscribe(function (langres) {
                            langres && (messageData_1.abstract = langres['CONTACT_ADD_SEND_RESPONSE']);
                            _this.messageProvider._sendMsg(messageData_1).subscribe();
                        });
                    }
                }, 100);
            }
    ...
    ContactAddPage.prototype.openScanPage = function () {
        this.navCtrl.push('ScanPage');
    };
    ContactAddPage.prototype.searchMember = function (key) {
        var _this = this;
        this.contacts = [];
        if (key) {
            this.isSearch = true;
            ...
            this.contactProvider.SearchMember(key).subscribe(function (res) {
                _this.contacts.push(res.result);
                _this.isDataEmpty = !res.result;
    ...
    ContactAddPage.prototype.openMyCode = function () {
        this.navCtrl.push('MycodePage');
    };
    ContactAddPage.prototype.openMemberDetails = function (contact) {
        this.navCtrl.push('ContactDetailPage', { friendId: contact['id'] });
    };
    ContactAddPage.prototype.LatestFriendRequest = function () {
        var _this = this;
        this.contactProvider.LatestFriendRequest().subscribe(function (res) {
            _this.latestFriends = res.result;
        });
    };
    ContactAddPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_5__angular_core__["Component"])({
            selector: 'page-contact-add',template:/*ion-inline-start:"F:\iproud2.5-pwa\src\pages\contact\contact-add\contact-add.html"*/'<ion-header>\n\n\n\n  <ion-navbar >\n\n     \n\n    <ion-title>{{\'CONTACT_ADD_TITLE\'|translate}}</ion-title>\n\n  </ion-navbar>\n\n\n\n  <ion-toolbar>\n\n    <ion-searchbar list="cars" placeholder="{{\'CONTACT_ADD_PHONE\'|translate}}" [(ngModel)]="searchKey" (ionInput)="searchMember(searchKey)"\n\n    (ionCancel)="onCancel($event)" [debounce]="1500"></ion-searchbar>\n\n    <ion-buttons end>\n\n      <button ion-button icon-only (click)="searchMember(searchKey)">\n\n        {{\'HOME_SEARCH_LIST\' | translate}}\n\n      </button>\n\n    </ion-buttons>\n\n  </ion-toolbar>\n\n</ion-header>\n\n\n\n\n\n<ion-content>\n\n\n\n  \n\n  <ion-list *ngIf="!isSearch"> \n\n\n\n    <button ion-item (click)="openScanPage()">\n\n      <ion-avatar item-start>\n\n        <img src="assets/img/scan.png" />\n\n      </ion-avatar>\n\n      <ion-label>\n\n        <h2>{{\'CONTACT_ADD_SCAN\'|translate}}</h2>\n\n        <p>{{\'CONTACT_ADD_SCAN_INFO\'|translate}}</p>\n\n      </ion-label>\n\n    </button>\n\n\n\n    <button ion-item (click)="openMyCode()">\n\n      <ion-avatar item-start>\n\n        <img src="assets/img/qr-code-circle.png" />\n\n      </ion-avatar>\n\n      <ion-label>\n\n        <h2>{{\'CONTACT_ADD_MYCODE\'|translate}}</h2>\n\n        <p>{{\'CONTACT_ADD_MYCODE_INFO\'|translate}}</p>\n\n      </ion-label>\n\n    </button>\n\n\n\n    <ion-item-divider>\n\n        {{\'CONTACT_ADD_NEW_REQUEST\'|translate}}\n\n    </ion-item-divider>\n\n\n\n    <ion-item    *ngFor="let contact of latestFriends">\n\n      <ion-avatar item-start>\n\n        <img [src]="contact?.avator" />\n\n      </ion-avatar>\n\n      <ion-label>\n\n        <h2>{{contact.name}}</h2>\n\n        <p>{{contact.description}}</p> \n\n      </ion-label> \n\n        <button *ngIf="contact?.status == \'waiting\'" item-end ion-button small color="gray" (click)="doRejectAddRequest(contact)">{{\'CONTACT_ADD_NEW_REQUEST_REJECT\'|translate}}</button>\n\n        <button *ngIf="contact?.status == \'waiting\'" item-end ion-button small   (click)="doAgreeAddRequest(contact)">{{\'CONTACT_ADD_NEW_REQUEST_AGREE\'|translate}}</button>\n\n\n\n        <button *ngIf="contact?.status == \'accepted\' || contact?.status == \'rejected\' || contact?.status == \'expired\'" [disabled]="true" item-end ion-button small color="gray" >{{contact?.status }}</button>\n\n \n\n    </ion-item>\n\n \n\n  </ion-list>\n\n\n\n  <ion-list *ngIf="isSearch">\n\n      <div text-center *ngIf="isSearch && isDataLoading" padding>\n\n          <ion-spinner name="ios"></ion-spinner>\n\n        </div>\n\n    <nodata text="{{\'APP_COMMON_NODATA\' | translate}}" translateKey="APP_COMMON_NODATA" *ngIf="isDataEmpty && !isDataLoading"></nodata>\n\n    <ion-item (click)="openMemberDetails(contact)" *ngFor="let contact of contacts">\n\n      <ion-avatar item-start>\n\n        <img [src]="contact?.avator" />\n\n      </ion-avatar>\n\n      <ion-label>\n\n        <h2>{{contact.name}}</h2>\n\n      </ion-label>\n\n    </ion-item>\n\n  </ion-list>\n\n\n\n\n\n\n\n</ion-content>\n\n'/*ion-inline-end:"F:\iproud2.5-pwa\src\pages\contact\contact-add\contact-add.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_0__angular_common_http__["a" /* HttpClient */],
            __WEBPACK_IMPORTED_MODULE_6_ionic_angular__["p" /* NavController */],
            __WEBPACK_IMPORTED_MODULE_6_ionic_angular__["q" /* NavParams */],
            __WEBPACK_IMPORTED_MODULE_4__providers_contact_provider__["a" /* ContactProvider */],
            __WEBPACK_IMPORTED_MODULE_6_ionic_angular__["b" /* AlertController */],
            __WEBPACK_IMPORTED_MODULE_6_ionic_angular__["g" /* Events */],
            __WEBPACK_IMPORTED_MODULE_3__providers_message_provider__["a" /* MessageProvider */],
            __WEBPACK_IMPORTED_MODULE_2__ngx_translate_core__["c" /* TranslateService */]])
    ], ContactAddPage);
    return ContactAddPage;
}());

//# sourceMappingURL=contact-add.js.map
