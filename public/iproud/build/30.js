...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MyActivitiesPageModule", function() { return MyActivitiesPageModule; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__my_activities__ = __webpack_require__(1232);
...
var MyActivitiesPageModule = (function () {
    function MyActivitiesPageModule() {
    }
    MyActivitiesPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_2__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_4__my_activities__["a" /* MyActivitiesPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_3_ionic_angular__["k" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_4__my_activities__["a" /* MyActivitiesPage */]),
                __WEBPACK_IMPORTED_MODULE_1__ngx_translate_core__["b" /* TranslateModule */].forChild(),
                __WEBPACK_IMPORTED_MODULE_0__components_components_module__["a" /* ComponentsModule */]
            ],
        })
    ], MyActivitiesPageModule);
    return MyActivitiesPageModule;
}());

//# sourceMappingURL=my-activities.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return MyActivitiesPage; });
 ...
 */
var MyActivitiesPage = (function () {
    function MyActivitiesPage(navCtrl, navParams, clubProvider, session) {
        this.navCtrl = navCtrl;
    ...
    MyActivitiesPage.prototype.ionViewDidLoad = function () {
        this.getActivites();
    };
    MyActivitiesPage.prototype.getActivites = function (_event) {
        this.activites = [];
    ...
    MyActivitiesPage.prototype.doInfinite = function (_event) {
        // this.clubProvider.getEvents(this.pageCount).subscribe(res=>{ 
        //   this.hasMoreData = Math.floor(Math.random() * 10) % 3 != 1;
        //   this.activites.push.apply(this.activites,res);
        //   _event.complete();
        // }) 
    };
    MyActivitiesPage.prototype.doRefresh = function (_event) {
        _event.complete();
        this.getActivites(_event);
    };
    MyActivitiesPage.prototype.openDetails = function (item) {
        this.navCtrl.push('ActivityDetailsPage', item);
    };
    MyActivitiesPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_2__angular_core__["Component"])({
            selector: 'page-my-activities',template:/*ion-inline-start:"F:\iproud2.5-pwa\src\pages\community\my\my-activities\my-activities.html"*/'<!--\n\n  Generated template for the MyActivitiesPage page.\n\n\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n\n  Ionic pages and navigation.\n\n-->\n\n<ion-header>\n\n  <ion-navbar>\n\n    <ion-title>my-activities</ion-title>\n\n  </ion-navbar>\n\n\n\n  <ion-item no-lines>\n\n    <span item-start class="segment-title">我的报名（20）</span>\n\n    <ion-icon item-end name="menu" (click)="openModal()"></ion-icon>\n\n  </ion-item>\n\n</ion-header>\n\n\n\n<ion-content>\n\n  <ion-refresher (ionRefresh)="doRefresh($event)">\n\n    <ion-refresher-content pullingIcon="arrow-dropdown">\n\n    </ion-refresher-content>\n\n  </ion-refresher>\n\n\n\n  <iproud-load-data [isDataEmpty]="isDataEmpty" [isDataLoading]="isDataLoading"\n\n    text="{{ \'WORKFLOW_UNDONETASK_HINT\' | translate }}">\n\n  </iproud-load-data>\n\n\n\n  <ion-list>\n\n    <ion-item class="event" *ngFor="let item of activites" (click)="openDetails(item)">\n\n      <div class="club">\n\n        <!-- <img [src]="item.clubImage"/> -->\n\n        <div class="club-img" [style.background-image]="\'url(\' + item.clubImage + \')\'"></div>\n\n        <span class="club-title">{{ item.clubName }}</span>\n\n      </div>\n\n\n\n      <div class="event-image">\n\n        <img [src]="item.eventImage" />\n\n      </div>\n\n      <span class="event-type">{{ item.eventType }}: </span>\n\n      <p class="text light">{{ item.title }}</p>\n\n      <p class="text">\n\n        活动时间: <span>{{ item.eventTime }}</span>\n\n      </p>\n\n      <p class="text">\n\n        地点: <span>{{ item.eventPlace }}</span>\n\n      </p>\n\n      <div class="event-status" [ngClass]="{\n\n          \'event-status-apply-failed\': item.eventStatus == -1,\n\n          \'event-status-apply-success\': item.eventStatus == 1,\n\n          \'event-status-apply-ing\': item.eventStatus == 0\n\n        }">\n\n        <span class="event-status-name">{{ item.eventStatusName }}</span>\n\n      </div>\n\n    </ion-item>\n\n  </ion-list>\n\n  <ion-infinite-scroll *ngIf="hasMoreData" (ionInfinite)="doInfinite($event)">\n\n    <ion-infinite-scroll-content aria-posinset="button" loadingSpinner="bubbles">\n\n    </ion-infinite-scroll-content>\n\n  </ion-infinite-scroll>\n\n</ion-content>\n\n'/*ion-inline-end:"F:\iproud2.5-pwa\src\pages\community\my\my-activities\my-activities.html"*/,
        }),
