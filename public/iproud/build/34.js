...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__achievement__ = __webpack_require__(1184);
...
var AchievementPageModule = (function () {
    function AchievementPageModule() {
    }
    AchievementPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_2__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_4__achievement__["a" /* AchievementPage */],
            ],
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_3_ionic_angular__["k" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_4__achievement__["a" /* AchievementPage */]),
            ],
        })
 ...
 */
var AchievementPage = (function () {
    function AchievementPage(navCtrl, navParams, element, cd, modal, socialProvider, storage, session) {
        this.navCtrl = navCtrl;
        ...
        this._offsetLefts = [];
        this._ids = [];
        this.getAchievementByStorage();
        this.getAchievement();
    }
    AchievementPage.prototype.ionViewDidLoad = function () {
        // let datalist = []
        // let headerTitles = ['携手并进 共赢未来','百尺竿头，更进一步','匠心独运 别具一格','知行合一 奖罚分明','有口皆碑 社交达人']
        // let titles = ['训练','训练','提案','考勤','其他']
        // for(let i = 0; i < headerTitles.length;i++){
        //   let item = {
        //     type: titles[i],
        //     description: headerTitles[i]
        //   }
        //   let data = []
        //   let names = [['小小伯乐','明星伯乐','超级伯乐'],
        //               ['诲人不倦','能者为师','德高望重','崭露头角','温故知新','文质彬彬'],
        //               ['提案能手','提案达人','提案大神'], 
        //               ['略有小成','炉火纯青','傲视群雄'],
        //               ['新手上路','后起之秀','知无不言']]
        ...
        //     let details ={
        //       id:j,
        //       icon: `assets/img/achievement/medal/${names[i][j]}.png`,
        //       description: '授课学时在10小时以上',
        //       name: names[i][j],
        //       isAward: j == 0 || j == 1
        //     }
        //     data.push(details)
        ...
        //   datalist.push(item)
        // }
        // this._createData(datalist)
    };
    AchievementPage.prototype.ngAfterViewChecked = function () {
        var _this = this;
        this._offsetTops = [];
        this._offsetLefts = [];
        this.achievementList.forEach(function (element) {
    ...
    AchievementPage.prototype._createData = function () {
        for (var _i = 0, _a = this.achievementList; _i < _a.length; _i++) {
            var item = _a[_i];
            item.elementId = 'achievementId' + item.id;
            this._ids.push(item.elementId);
        }
        this.topId = this.achievementList.length > 0 ? this.achievementList[0]['elementId'] : '';
        this.content.resize();
    };
    AchievementPage.prototype.selectScrollXItem = function (id) {
        this.topId = id;
        this.scrollTopByHandle();
        var ele = this.element.nativeElement.querySelector("#scroll-" + this.topId);
    };
    AchievementPage.prototype.scrollTopByHandle = function () {
        if (!this.topId)
            return;
        var ele = this.element.nativeElement.querySelector("#" + this.topId);
        this.content.scrollTop = ele.offsetTop;
    };
    AchievementPage.prototype.scrollxToLeft = function (left) {
        if (left === void 0) { left = 0; }
        this.scrollx._scrollContent.nativeElement.scrollLeft = left > 150 ? left - 150 : 0;
    };
    AchievementPage.prototype.scrollEvent = function (e) {
        var _this = this;
  ...
  */
    AchievementPage.prototype.scrollWidth = function (width, height) {
        return {
            "width": width || (window.screen.availWidth - 5) + 'px',
            "minHeight": 36 + 'px'
        };
    };
    AchievementPage.prototype.openAchieve = function (item) {
        var md = this.modal.create('AchieveItemPage', item, {
            enterAnimation: 'modal-scale-enter',
            leaveAnimation: 'modal-scale-leave',
            cssClass: 'achieveitem-backdrop',
        });
        md.present();
    };
    AchievementPage.prototype.getAchievement = function () {
        var _this = this;
        this.socialProvider.getAchievements().subscribe(function (res) {
            if (res && res.result) {
                if (_this.achievementList.length == res.result.length) {
                    res.result.forEach(function (element, index) {
                        element['elementId'] = _this.achievementList[index]['elementId'];
                        if (!__WEBPACK_IMPORTED_MODULE_1__services_utility__["a" /* Utility */].isEqualsObject(element, _this.achievementList[index])) {
                            _this.achievementList[index] = element;
                        }
                    });
                }
                else {
                    _this.achievementList = res.result;
                }
            }
            else {
                _this.achievementList = [];
            }
            _this.storage.setItem(_this.session.userId + ':achievement', _this.achievementList);
            _this._createData();
        });
    };
    AchievementPage.prototype.getAchievementByStorage = function () {
        return __awaiter(this, void 0, void 0, function () {
            var achievement;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.storage.getItem(this.session.userId + ':achievement')];
                    case 1:
                        achievement = _a.sent();
                        if (achievement) {
    ...
    ], AchievementPage.prototype, "content", void 0);
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_4__angular_core__["ViewChild"])('scroll'),
        __metadata("design:type", Object)
    ], AchievementPage.prototype, "scrollx", void 0);
    AchievementPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_4__angular_core__["Component"])({
            selector: 'page-achievement',template:/*ion-inline-start:"F:\iproud2.5-pwa\src\pages\achievement\achievement\achievement.html"*/'<!--\n\n  Generated template for the AchievementPage page.\n\n\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n\n  Ionic pages and navigation.\n\n-->\n\n<ion-header>\n\n\n\n  <ion-navbar>\n\n    <ion-title>{{ \'SOCIAL_ACHIEVEMENT_TITLE\'| translate}}</ion-title>\n\n  </ion-navbar>\n\n  <ion-toolbar class="scroll-toolbar" *ngIf="achievementList && achievementList.length > 0"> \n\n      <ion-scroll #scroll scrollX="true" [ngStyle]="scrollWidth()">\n\n        <div class="scrollx-container">\n\n          <span [id]="\'scroll-\' + item.elementId" class="type" *ngFor="let item of achievementList,let indx = index" \n\n          (click)="selectScrollXItem(item.elementId)" [ngClass]="{\'selected\': topId == item.elementId}" >\n\n          {{item.category}}\n\n        </span>\n\n        </div> \n\n      </ion-scroll> \n\n    </ion-toolbar>\n\n</ion-header>\n\n\n\n\n\n<ion-content (ionScroll)="scrollEvent($event)">\n\n    <div class="container" [id]="achieveItem.elementId" *ngFor="let achieveItem of achievementList,let index = index" [ngClass]="index == achievementList.length-1 ? \'last-item\': \'\'">\n\n        <div class="header" text-center margin-top >\n\n            <span>{{achieveItem.description}}</span>\n\n        </div>\n\n        <ion-grid class="achievelist">\n\n            <ion-row>\n\n                <ion-col col-4 text-center *ngFor="let achieve of achieveItem.medals">\n\n                    <button text-center (click)="openAchieve(achieve)" [ngClass]="{\'garyscale\': !achieve.isTake}"> \n\n                        <img-lazy-load [src]="achieve.iconUrl" ></img-lazy-load>\n\n                         \n\n                        <br/> \n\n                        <span class="achieve-name">{{achieve.name}}</span>\n\n                        \n\n                    </button>\n\n                </ion-col>\n\n            </ion-row>\n\n        </ion-grid>\n\n        <div class="divider" *ngIf="index != achievementList.length-1"> </div>\n\n    </div> \n\n</ion-content>\n\n'/*ion-inline-end:"F:\iproud2.5-pwa\src\pages\achievement\achievement\achievement.html"*/,
        }),
