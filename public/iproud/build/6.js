...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SetposterPageModule", function() { return SetposterPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__setposter__ = __webpack_require__(1301);
...
var SetposterPageModule = (function () {
    function SetposterPageModule() {
    }
    SetposterPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__setposter__["a" /* SetposterPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["k" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__setposter__["a" /* SetposterPage */]),
                __WEBPACK_IMPORTED_MODULE_3__ngx_translate_core__["b" /* TranslateModule */].forChild(),
                __WEBPACK_IMPORTED_MODULE_4__components_components_module__["a" /* ComponentsModule */]
            ],
        })
    ], SetposterPageModule);
    return SetposterPageModule;
}());

//# sourceMappingURL=setposter.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return SetposterPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__workflow_tabs_workflow_common__ = __webpack_require__(1135);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__services_session__ = __webpack_require__(19);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__angular_core__ = __webpack_require__(0);
...
/**
 * Generated class for the SetposterPage page.
 *
 * See https://ionicframework.com/docs/components/#navigation for more info on
 * Ionic pages and navigation.
 */
var SetposterPage = (function (_super) {
    __extends(SetposterPage, _super);
    function SetposterPage(navCtrl, navParams, session, storageService, alertCtrl, translateService, events, viewCtrl, workflowProvider) {
        var _this = _super.call(this, navCtrl, events) || this;
        _this.navCtrl = navCtrl;
        ...
        _this.agentType = '01';
        _this.validAgent = false;
        _this.agentErrorStr = '';
        _this.normal = false;
        _this.special = true;
        _this.setEnabled = false;
        _this.showAlert = false;
        _this.currrentUserName = ' ';
        _this.validateInput();
        _this.getHistoryAgents();
        if (_this.session.user && _this.session.user.employeeInfo) {
            _this.currrentUserName = _this.session.user.employeeInfo.staffNumber + ' ' + _this.session.user.employeeInfo.employeeName;
            _this.userCode = _this.session.user.employeeInfo.staffNumber;
        }
        return _this;
    }
    SetposterPage.prototype.getHistoryAgents = function () {
        var _this = this;
        this.workflowProvider.AgentHisList().subscribe(function (res) {
            if (res.result) {
                _this.historyAgents = res.result;
            }
        });
    };
    SetposterPage.prototype.scrollWidth = function () {
        return _super.prototype.scrollWidth.call(this, null, 40);
    };
    /***
     * 根据工号获取姓名
     */
    SetposterPage.prototype.getUserName = function () {
        var _this = this;
        if (this.agentCode) {
            if (this.agentCode.indexOf(this.userCode) != -1) {
                this.agentErrorStr = this.translateService.instant('WORKFLOW_SET_AGENT_NOT_YOURSELF');
            }
            else {
                var agentCode_1 = this.agentCode.split(' ')[0];
                this.workflowProvider.UserName(agentCode_1).subscribe(function (res) {
                    if (res.result) {
                        _this.validAgent = true;
                        _this.agentCode = agentCode_1 + ' ' + res.result;
                    }
                    else {
                        _this.agentErrorStr = _this.translateService.instant('WORKFLOW_SET_AGENT_NO_EMPLOYEE');
                        _this.validAgent = false;
                    }
                    _this.validateInput();
                });
            ...
            this.agentErrorStr = '';
            this.validAgent = false;
            this.validateInput();
        }
    };
    SetposterPage.prototype.focusInput = function () {
        this.agentErrorStr = '';
        this.validAgent = false;
        this.validateInput();
    };
    SetposterPage.prototype.changeAgentType = function (index) {
        if (index == 1) {
            this.agentType = '01';
            this.normal = !this.special;
        }
        else {
    ...
    SetposterPage.prototype.chooseHistory = function (item) {
        if (item.agentcode) {
            this.agentCode = item.agentcode + ' ' + item.name;
        }
        this.agentErrorStr = '';
        this.validAgent = true;
        this.validateInput();
    };
    /**
     * 设置代理人
     */
    SetposterPage.prototype.setAgent = function () {
        var _this = this;
        var agentCode = this.agentCode.split(' ')[0];
        this.workflowProvider.addAgent(this.userCode, agentCode, this.agentType, this.startDate, this.endDate, this.remark).subscribe(function (data) {
            _this.events.publish('set-agent-success');
            _this.viewCtrl.dismiss();
        });
    };
    SetposterPage.prototype.validateInput = function () {
    ...
    SetposterPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_2__angular_core__["Component"])({
            selector: 'page-setposter',template:/*ion-inline-start:"F:\iproud2.5-pwa\src\pages\workflow\workflow-agent-setting\setposter.html"*/'<ion-header >\n\n\n\n  <ion-navbar>\n\n    <ion-title>{{\'WORKFLOW_SET_AGENT_TITLE\' | translate}}</ion-title>\n\n  </ion-navbar>\n\n\n\n</ion-header>\n\n\n\n<ion-content>\n\n\n\n\n\n  <ion-list>\n\n\n\n  <ion-item>\n\n    <ion-label>\n\n      {{\'WORKFLOW_SET_AGENT_USER\' | translate}}\n\n    </ion-label>\n\n    <ion-input class="input-readonly" text-right placeholder="{{\'WORKFLOW_SET_AGENT_EMPLOYEECARD\' | translate}}" [(ngModel)]="currrentUserName"\n\n      readonly></ion-input>\n\n  </ion-item>\n\n  <ion-item>\n\n    <ion-label>{{\'WORKFLOW_SET_AGENT_STARTDATE\' | translate}}</ion-label>\n\n    <ion-datetime displayFormat="MM/DD/YYYY" [(ngModel)]="startDate" (ngModelChange)="validateInput()" placeholder="{{\'WORKFLOW_SET_AGENT_INPUTSTART\' | translate}}"></ion-datetime>\n\n  </ion-item>\n\n  <ion-item>\n\n    <ion-label>{{\'WORKFLOW_SET_AGENT_ENDDATE\' | translate}}</ion-label>\n\n    <ion-datetime displayFormat="MM/DD/YYYY" [(ngModel)]="endDate" (ngModelChange)="validateInput()" placeholder="{{\'WORKFLOW_SET_AGENT_INPUTEND\' | translate}}"></ion-datetime>\n\n  </ion-item>\n\n  <p  class="error-alert" *ngIf="showAlert">{{\'DATE_ALERT_MESSAGE\' | translate}}</p>\n\n\n\n  <ion-item class="agent-type-container">\n\n    <ion-label>\n\n      {{\'WORKFLOW_SET_AGENT_TYPE\' | translate}}\n\n    </ion-label>\n\n    <div item-content>\n\n\n\n      <ion-grid>\n\n        <ion-row>\n\n          <ion-col align-self-center>\n\n            <ion-checkbox [(ngModel)]="special" (ngModelChange)="changeAgentType(1)"></ion-checkbox>\n\n          </ion-col>\n\n\n\n          <ion-col>\n\n            <ion-label style="margin-left: -20px;">\n\n              {{\'WORKFLOW_SET_AGENT_TYPE1\' | translate}}\n\n            </ion-label>\n\n          </ion-col>\n\n\n\n          <ion-col align-self-center>\n\n            <ion-checkbox [(ngModel)]="normal" (ngModelChange)="changeAgentType(2)"></ion-checkbox>\n\n\n\n          </ion-col>\n\n          <ion-col>\n\n            <ion-label style="margin-left: -20px;">\n\n              {{\'WORKFLOW_SET_AGENT_TYPE2\' | translate}}\n\n            </ion-label>\n\n          </ion-col>\n\n        </ion-row>\n\n      </ion-grid>\n\n\n\n    </div>\n\n  </ion-item>\n\n\n\n  <ion-item>\n\n    <ion-label>{{\'WORKFLOW_SET_AGENT_POSTMAN\' | translate}}</ion-label>\n\n    <ion-input [(ngModel)]="agentCode"   (ionFocus)="focusInput()" (ionBlur)="getUserName()" text-right placeholder="{{\'WORKFLOW_SET_AGENT_POSTMANID\' | translate}}"></ion-input> \n\n  </ion-item>\n\n\n\n  <p class="error-alert" *ngIf="agentErrorStr">{{agentErrorStr}}</p>\n\n\n\n  <ion-item>\n\n    <ion-scroll scrollX="true" [ngStyle]="scrollWidth()">\n\n        <div style="display: inline-flex;">\n\n          <button ion-button outline small *ngFor="let item of historyAgents"  (click)="chooseHistory(item)"  >{{item.name}} \n\n          </button>\n\n        </div>\n\n    </ion-scroll>\n\n  </ion-item>\n\n\n\n\n\n  <ion-item>\n\n    <ion-label>{{\'WORKFLOW_SET_AGENT_ABOUT\' | translate}}</ion-label>\n\n    <ion-textarea text-right [(ngModel)]="remark" placeholder="{{\'WORKFLOW_SET_AGENT_NUMBER\' | translate}}"></ion-textarea>\n\n  </ion-item>\n\n\n\n  <div class="explain-container">\n\n    <p text-left>\n\n      <ion-icon name="star-outline"></ion-icon>\n\n      <span class="explain">\n\n        {{\'WORKFLOW_SET_AGENT_ALERT1\' | translate}}\n\n      </span>\n\n    </p>\n\n    <p text-left>\n\n      <ion-icon name="star-outline"></ion-icon>\n\n      <span class="explain">\n\n        {{\'WORKFLOW_SET_AGENT_ALERT2\' | translate}}\n\n      </span>\n\n    </p>\n\n  </div>\n\n\n\n</ion-list>\n\n\n\n  <ion-grid>\n\n    <ion-row>\n\n      <ion-col>\n\n        <button (click)="setAgent()" ion-button [disabled]="!setEnabled" color="primary" block>{{\'WORKFLOW_SET_AGENT_BUTTON\'\n\n          | translate}}</button>\n\n      </ion-col>\n\n\n\n    </ion-row>\n\n  </ion-grid>\n\n  \n\n\n\n</ion-content>\n\n'/*ion-inline-end:"F:\iproud2.5-pwa\src\pages\workflow\workflow-agent-setting\setposter.html"*/,
        }),
    ...
    return SetposterPage;
}(__WEBPACK_IMPORTED_MODULE_0__workflow_tabs_workflow_common__["a" /* workflowCommon */]));

//# sourceMappingURL=setposter.js.map
