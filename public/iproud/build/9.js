...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "IdlRecruitmentListPageModule", function() { return IdlRecruitmentListPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__idl_recruitment_list__ = __webpack_require__(1295);
...
var IdlRecruitmentListPageModule = (function () {
    function IdlRecruitmentListPageModule() {
    }
    IdlRecruitmentListPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__idl_recruitment_list__["a" /* IdlRecruitmentListPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["k" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__idl_recruitment_list__["a" /* IdlRecruitmentListPage */]),
                __WEBPACK_IMPORTED_MODULE_4__ngx_translate_core__["b" /* TranslateModule */].forChild(),
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */]
            ],
        })
    ], IdlRecruitmentListPageModule);
    return IdlRecruitmentListPageModule;
}());

//# sourceMappingURL=idl-recruitment-list.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return IdlRecruitmentListPage; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__providers_idl_recruiting_provider__ = __webpack_require__(598);
...
/**
 * Generated class for the IdlRecruitmentListPage page.
 *
 * See https://ionicframework.com/docs/components/#navigation for more info on
 * Ionic pages and navigation.
 */
var IdlRecruitmentListPage = (function (_super) {
    __extends(IdlRecruitmentListPage, _super);
    function IdlRecruitmentListPage(navCtrl, session, idlrecruitingProvider, translateService, navParams, widgetProvider) {
        var _this = _super.call(this, navCtrl) || this;
        _this.navCtrl = navCtrl;
        _this.session = session;
        _this.idlrecruitingProvider = idlrecruitingProvider;
        ...
        _this.page = 0;
        _this.count = 20;
        _this.title = _this.navParams.data.widgetName || _this.translateService.instant('HOME_ENGINEER_RECRUITMENT');
        _this.appId = _this.navParams.data.appId;
        _this.typeOptions = [{ postName: _this.translateService.instant('RECRUITMENT_IDL_ALLTYPE'), id: '' }];
        _this.areaOptions = [{ siteName: _this.translateService.instant('RECRUITMENT_IDL_ALLAREA'), id: '' }];
        _this.selectedArea = _this.areaOptions[0].id;
        _this.selectedType = _this.typeOptions[0].id;
        _this.idlrecruitingProvider.PostTypes().subscribe(function (data) {
            if (data.errcode == 0) {
                _this.typeOptions.push.apply(_this.typeOptions, data.result);
            }
        });
        _this.idlrecruitingProvider.WorkSites().subscribe(function (data) {
            if (data.errcode == 0) {
                _this.areaOptions.push.apply(_this.areaOptions, data.result);
            }
        });
        _this.idlrecruitingProvider.PostList(_this.selectedArea, '', _this.page * _this.count, _this.count).subscribe(function (data) {
            if (data.errcode == 0) {
                _this.jobs = data.result;
                _this.finiteScroll = data.result.length == _this.count ? true : false;
                for (var _i = 0, _a = _this.jobs; _i < _a.length; _i++) {
                    var item = _a[_i];
                    item.distributedOn = __WEBPACK_IMPORTED_MODULE_2__services_utility__["a" /* Utility */].formatTime(_this.session.language, item.distributedOn, 'YYYY-MM-DD');
                }
            }
        });
        return _this;
    }
    IdlRecruitmentListPage.prototype.ionViewDidLoad = function () {
    };
    // openPostDetail(item) {
    //   this.navCtrl.push('IdlRecruitmentPage', item)
    // }
    IdlRecruitmentListPage.prototype.openPostDetail = function (item) {
        var widget = this.widgetProvider.getWidgetById(this.appId);
        var page = {
            url: "https://fishnet.fih-foxconn.com/Job/MPRJobEdit/?accountId=" + this.session.userId + "&postId=" + item.id,
    ...
    IdlRecruitmentListPage.prototype.selectAreaOption = function (select) {
        this.selectedArea = select;
        this.filterJobs();
    };
    IdlRecruitmentListPage.prototype.selectTypeOption = function (select) {
        this.selectedType = select;
        this.filterJobs();
    };
    IdlRecruitmentListPage.prototype.selectClassOption = function (select) {
        this.selectedClass = select;
    };
    IdlRecruitmentListPage.prototype.filterJobs = function (_event) {
        this.page = 0;
        this.pageFilter(_event || false, true);
    };
    IdlRecruitmentListPage.prototype.pageFilter = function (infiniteScroll, isFilter) {
        var _this = this;
        this.idlrecruitingProvider.PostList(this.selectedArea, this.selectedType, this.page * this.count, this.count).subscribe(function (data) {
            _super.prototype.completeRefresh.call(_this, infiniteScroll);
            if (data.errcode == 0) {
                if (isFilter) {
                    _this.jobs = data.result;
                }
                else {
                    _this.jobs = _this.jobs.concat(data.result);
                }
                _this.finiteScroll = data.result.length == _this.count ? true : false;
            }
        }, function (err) {
    ...
    //加载更多数据
    IdlRecruitmentListPage.prototype.doInfinite = function (infiniteScroll) {
        this.page++;
        this.pageFilter(infiniteScroll);
    };
    IdlRecruitmentListPage.prototype.doRefresh = function (_event) {
        this.filterJobs(_event);
    };
    IdlRecruitmentListPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_4__angular_core__["Component"])({
            selector: 'page-idl-recruitment-list',template:/*ion-inline-start:"F:\iproud2.5-pwa\src\pages\recruitment\idl-recruitment-list\idl-recruitment-list.html"*/'<!--\n\n  Generated template for the PostPage page.\n\n\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n\n  Ionic pages and navigation.\n\n-->\n\n<ion-header >\n\n\n\n    <ion-navbar >\n\n      <ion-title>{{title }}</ion-title>\n\n    </ion-navbar>\n\n  \n\n    <ion-toolbar>\n\n        <ion-grid class="option">\n\n            <ion-row>\n\n              <ion-col col-6 text-center >\n\n                \n\n                  <ion-select [(ngModel)]="selectedArea" (ngModelChange)="selectAreaOption(selectedArea)" okText="{{\'APP_COMMON_CONFIRM\' | translate}}" cancelText="{{\'APP_COMMON_CANCEL\' | translate}}" > \n\n                      <ion-option [value]="item.id" *ngFor="let item of areaOptions">{{item.siteName}}</ion-option> \n\n                    </ion-select>\n\n              </ion-col>\n\n              <ion-col col-6 text-center >\n\n                  <ion-select [(ngModel)]="selectedType" (ngModelChange)="selectTypeOption(selectedType)" okText="{{\'APP_COMMON_CONFIRM\' | translate}}" cancelText="{{\'APP_COMMON_CANCEL\' | translate}}"    >\n\n                      <ion-option [value]="item.id" *ngFor="let item of typeOptions">{{item.postName}}</ion-option> \n\n                    </ion-select>\n\n              </ion-col>\n\n              <!-- <ion-col col-5 text-center >\n\n                  <ion-select [(ngModel)]="selectedClass" (ngModelChange)="selectClassOption(selectedType)">\n\n                      <ion-option value="{{item.value}}" *ngFor="let item of classOptions">{{item.name}}</ion-option> \n\n                    </ion-select>\n\n              </ion-col> -->\n\n            </ion-row>\n\n          </ion-grid>\n\n  \n\n       \n\n    </ion-toolbar>\n\n  \n\n  </ion-header>\n\n  \n\n  \n\n  <ion-content >\n\n\n\n      <ion-refresher (ionRefresh)="doRefresh($event)">\n\n          <ion-refresher-content pullingIcon="arrow-dropdown" pullingText="{{\'HOME_PULL_REFRESH\' | translate }}"\n\n            refreshingText="{{\'HOME_REFRESH\' | translate }}">\n\n          </ion-refresher-content>\n\n        </ion-refresher>\n\n\n\n    <ion-list>\n\n      <ion-item *ngFor="let item of jobs" (click)="openPostDetail(item)">\n\n        <h2>{{item.postName}}</h2>\n\n        <ion-grid>\n\n          <ion-row>\n\n            <ion-col col-4 text-left ><span>{{item.workplace}}</span></ion-col>\n\n            <ion-col col-5 text-left ><span>{{item.department}}</span></ion-col>\n\n            <ion-col col-3 text-right ><span>{{item.distributedOn}}</span></ion-col>\n\n          </ion-row>\n\n        </ion-grid>\n\n        <div class="article"> \n\n          <span>{{\'RECRUITMENT_IDL_WORK_DUTY\' | translate }}</span>\n\n          <span>{{item.dutyRequirement}}</span>\n\n        </div> \n\n      </ion-item>\n\n\n\n      <data-hints text="{{\'APP_COMMON_NO_MORE\' | translate}}" *ngIf="!finiteScroll  "></data-hints>  \n\n    </ion-list>\n\n  \n\n     <!-- 上滑的时候,加载数据 -->\n\n     <ion-infinite-scroll *ngIf="finiteScroll" (ionInfinite)="doInfinite($event)">\n\n        <ion-infinite-scroll-content aria-posinset="button" loadingSpinner="bubbles">\n\n        </ion-infinite-scroll-content>\n\n      </ion-infinite-scroll>\n\n  </ion-content>\n\n  '/*ion-inline-end:"F:\iproud2.5-pwa\src\pages\recruitment\idl-recruitment-list\idl-recruitment-list.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_5_ionic_angular__["p" /* NavController */],
            ...
            __WEBPACK_IMPORTED_MODULE_6__providers_idl_recruiting_provider__["a" /* IDLRecruitingProvider */],
    ...
    ], IdlRecruitmentListPage);
    return IdlRecruitmentListPage;
}(__WEBPACK_IMPORTED_MODULE_7__page_base__["a" /* pageCommon */]));

//# sourceMappingURL=idl-recruitment-list.js.map
