...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "WorkflowDetailsPageModule", function() { return WorkflowDetailsPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__workflow_details__ = __webpack_require__(1303);
...
var WorkflowDetailsPageModule = (function () {
    function WorkflowDetailsPageModule() {
    }
    WorkflowDetailsPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__workflow_details__["a" /* WorkflowDetailsPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["k" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__workflow_details__["a" /* WorkflowDetailsPage */]),
                __WEBPACK_IMPORTED_MODULE_3__ngx_translate_core__["b" /* TranslateModule */].forChild(),
                __WEBPACK_IMPORTED_MODULE_4__components_components_module__["a" /* ComponentsModule */]
            ],
        })
    ], WorkflowDetailsPageModule);
    return WorkflowDetailsPageModule;
}());

//# sourceMappingURL=workflow-details.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return WorkflowDetailsPage; });
...
/**
 *
 *  @param from  workflowdetails 來源 'message','undonetask','donetask','mytask'
 */
var WorkflowDetailsPage = (function () {
    function WorkflowDetailsPage(navCtrl, navParams, nativeService, wfprovider, translateService, alertCtrl, events, widgetProvider, cdf, session) {
        this.navCtrl = navCtrl;
        ...
        this.taskItem = this.navParams.data;
     ...
     * N流程沒有做移動簽核，
     * B流程有做移動簽核但該節點不行，
     * C表示該節點不是Ready狀態(是InActive或Complete等)或者已做簽核標記，
     * Y表示可以手機簽核 (只有在Y狀態下才可以審核)
     */
    WorkflowDetailsPage.prototype.getDetails = function (_RefreshEvent) {
        var _this = this;
        this.isLoadingData = true;
        this.sourceUrl = false;
        this.wfprovider.getTaskDetails(this.taskItem.pid, this.taskItem.taskid, this.taskItem.modelname).subscribe(function (res) {
            if (res.result) {
                /*  && res.result.SourceUrl[0].sourceurl */
                if (res.result.SourceUrl && res.result.SourceUrl.length > 0) {
                    _this.sourceUrl = res.result.SourceUrl[0].detailflag == 'Y';
                    // this.sourceUrl = 'https://www.popochiu.com/file/download/getpdf' || res.result.SourceUrl[0].sourceurl ;
                    _this.isNeedSign = res.result.SourceUrl[0].signflag === 'Y' && __WEBPACK_IMPORTED_MODULE_1__services_constants__["o" /* ENABLE_ELECTRONIC_SIGNATURE */];
                }
                // else {
                //   this.sourceUrl = 'https://www.popochiu.com/file/download/getpdf' || res.result.SourceUrl[0].sourceurl ;
                // }
                _this.taskDetails = (res.result.Head && res.result.Head.length > 0) ? res.result.Head[0] : { flag: 'C' };
                _this.ApprovalInfo = res.result.ApprovalInfo;
                if (!_this.isFinished) {
                    _this.flag = _this.taskDetails.flag && _this.taskDetails.flag.toUpperCase();
                }
                _this.Head = _this.createFormMain(res.result.Head);
                _this.formItems = _this.createForm(res.result.Items);
            }
            setTimeout(function () {
                _this.cdf && _this.cdf.detectChanges();
                _this.content && _this.content.resize();
            }, 100);
        }, function (err) {
        }, function () {
    ...
    WorkflowDetailsPage.prototype.doRefresh = function (event) {
     ...
     * @param metaarray
     */
    WorkflowDetailsPage.prototype.createForm = function (metaarray) {
        if (!metaarray || metaarray.length == 0)
            return [];
        var final = [];
        for (var _i = 0, metaarray_2 = metaarray; _i < metaarray_2.length; _i++) {
            var Items = metaarray_2[_i];
            var resarray = [];
            var obj = Items;
            var array = Object.keys(obj);
    ...
    WorkflowDetailsPage.prototype.slideWidth = function (index) {
        if (this.formItems.length == index) {
            return {
            ...
            return {
                "width": screen.availWidth - 100 + 'px !important'
            };
        }
    };
    WorkflowDetailsPage.prototype.ionViewDidLoad = function () {
    };
    WorkflowDetailsPage.prototype.rejectTask = function () {
        if (!this.approval) {
            this.nativeService.showToast(this.translateService.instant('WORKFLOW_DETAILS_REJECT_TOAST'));
            this.content.scrollToBottom();
            return;
        }
        this.doApproveTask('Reject');
    };
    WorkflowDetailsPage.prototype.adoptTask = function () {
        var _this = this;
        if (this.isNeedSign) {
            this.wfprovider.getCertification().then(function (cer) {
                _this.doApproveTask('Approve', cer);
            }).catch(function (err) {
                switch (err.errcode) {
                    case -1:
                        _this.notConfigCert();
                    ...
                    case -4:
                        ...
                        break;
                    case -5:
                        _this.nativeService.showToast(_this.translateService.instant('EMPLOYEE_NOT_BIND_YET'));
                        break;
                    case -6:
                        _this.certNotMatchCurrentUser();
                        break;
                    default:
                        _this.certIsUnexpected();
                }
            ...
            this.doApproveTask('Approve');
        }
    };
    // 证书所有者与当前用户不匹配
    WorkflowDetailsPage.prototype.certNotMatchCurrentUser = function () {
        var title = this.translateService.instant('CERTIFICATE_NOMATCH_TITLE');
        var subTitle = this.translateService.instant('CERTIFICATE_NOMATCH_SUBTITLE');
        var message = "" + this.translateService.instant('CERTIFICATE_NOMATCH_SUBJECT') + this.wfprovider.getCertSubjectName(this.wfprovider.cert) + "\n    <br/>\n    " + this.translateService.instant('CERTIFICATE_NOMATCH_CURRENT') + this.session.user.employeeInfo.employeeName + "\n    ";
        this.nativeService.alert(title, subTitle, message);
    };
    WorkflowDetailsPage.prototype.certIsUnexpected = function () {
        this.nativeService.showToast(this.translateService.instant('WORKFLOW_DETAILS_CERT_EXCEPTION'));
    };
    // 证书已过期
    WorkflowDetailsPage.prototype.certIsExpired = function () {
        this.nativeService.showToast(this.translateService.instant('WORKFLOW_DETAILS_CERT_EXPIRED'));
        this.notConfigCert();
    };
    WorkflowDetailsPage.prototype.notConfigCert = function () {
        var _this = this;
        var alert = this.alertCtrl.create();
        alert.setTitle(this.translateService.instant('WORKFLOW_DETAILS_CERT_TOAST'));
        alert.setSubTitle(this.translateService.instant('WORKFLOW_DETAILS_CERT_HINT'));
        alert.addButton({
            text: this.translateService.instant('WORKFLOW_DETAILS_CANCEL'),
            handler: function (data) {
            }
        });
        alert.addButton({
            text: this.translateService.instant('WORKFLOW_DETAILS_CERT_SET'),
            handler: function (data) {
                _this.navCtrl.push('CertificatePage', {
                    FromWF: true
                });
            }
        });
    ...
    /**
     * Status為Approve時為同意， Reject為拒單
     * @param type
  
     */
    WorkflowDetailsPage.prototype.doApproveTask = function (type, cert) {
        var _this = this;
        var approveTask = {
            ModelName: this.taskItem.modelname,
            PID: this.taskItem.pid,
            TID: this.taskItem.taskid,
            Status: type,
            UserCode: '',
        };
        if (this.isNeedSign && cert) {
            approveTask.SignFlag = 'Y';
            approveTask.Cert = cert.encryptData;
            approveTask.Pwd = cert.password;
        }
        this.wfprovider.doApproveTask(approveTask).subscribe(function () {
            setTimeout(function () {
                _this.events.publish('workflow:refresh-todo-list');
            }, 1000);
            _this.afterApproveTask();
        }, function (err) {
            var errorCode = err.errcode;
            _this.nativeService.showToast(errorCode + ':' + _this.translateService.instant('WORKFLOW_DETAILS_SIGN_FAILED'));
        });
    };
    WorkflowDetailsPage.prototype.afterApproveTask = function () {
        var _this = this;
        if (this.from == 'message') {
            var alert_1 = this.alertCtrl.create();
            alert_1.setTitle(this.translateService.instant('WORKFLOW_DETAILS_APPROVE_FINISH_TITLE'));
            alert_1.setSubTitle(this.translateService.instant('WORKFLOW_DETAILS_APPROVE_FINISH_SUBTITLE'));
            alert_1.addButton({
                text: this.translateService.instant('WORKFLOW_DETAILS_APPROVE_CLOSE'),
                handler: function (data) {
                    _this.navCtrl.pop();
                }
            });
            alert_1.addButton({
                text: this.translateService.instant('WORKFLOW_DETAILS_APPROVE_GOTODO'),
                handler: function (data) {
                    _this.navCtrl.pop();
                    _this.navCtrl.push('WorkflowPage');
                }
            });
            alert_1.present();
        }
    ...
    WorkflowDetailsPage.prototype.openSourceForm = function (sourceUrl) {
        var page = {
            url: sourceUrl,
            title: this.taskDetails.processnametw,
            description: this.taskDetails.taskdesctw,
            imageUrl: "",
            appId: "0",
            options: {}
        };
        this.navCtrl.push('PdfjsViewerPage', { title: this.taskDetails.processnametw, pid: this.taskDetails.pid });
        // this.widgetProvider.openByBrowser(OPEN_WIDGET_WAY.INAPPBROWSER, sourceUrl, this.navCtrl, null);
    };
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_6__angular_core__["ViewChild"])('nameInput'),
        __metadata("design:type", Object)
    ], WorkflowDetailsPage.prototype, "nameInput", void 0);
    __decorate([
    ...
    ], WorkflowDetailsPage.prototype, "content", void 0);
    WorkflowDetailsPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_6__angular_core__["Component"])({
            selector: 'page-workflow-details',template:/*ion-inline-start:"F:\iproud2.5-pwa\src\pages\workflow\workflow-details\workflow-details.html"*/'<!--\n\n  Generated template for the WorkflowDetailsPage page.\n\n\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n\n  Ionic pages and navigation.\n\n-->\n\n<ion-header>\n\n  <ion-navbar>\n\n    <ion-title>{{\'WORKFLOW_DETAILS_TASKINFO\' | translate}}</ion-title>\n\n  </ion-navbar>\n\n</ion-header>\n\n\n\n<ion-content> \n\n\n\n  <ion-refresher (ionRefresh)="doRefresh($event)">\n\n      <ion-refresher-content pullingIcon="arrow-dropdown" refreshingSpinner="circles">\n\n      </ion-refresher-content>\n\n    </ion-refresher>\n\n  <!--  -->\n\n  <!-- <div class="source-button"  text-right>\n\n    <button ion-button small outline\n\n      (click)="openSourceForm(sourceUrl)">{{\'WORKFLOW_DETAILS_VIEW_FORM\'| translate}}</button>\n\n  </div> -->\n\n  <ion-card>\n\n\n\n    <ion-card-header>\n\n      <ion-grid>\n\n        <ion-row>\n\n          <ion-col class="col-title" col-auto align-self-center>\n\n            <ion-icon name="alert-outline"></ion-icon>\n\n            <span>{{\'WORKFLOW_DETAILS_TITLE\' | translate}}</span>\n\n          </ion-col>\n\n          <ion-col class="e-contact-bill" col-auto align-self-center *ngIf="sourceUrl"> \n\n            \n\n              <button ion-button small round\n\n              (click)="openSourceForm(sourceUrl)">{{\'WORKFLOW_DETAILS_VIEW_FORM\'| translate}}</button>\n\n          \n\n            <!-- <span class="viewmore"  (click)="openSourceForm(sourceUrl)">{{\'WORKFLOW_DETAILS_VIEW_FORM\' | translate}}\n\n              <ion-icon name="ios-arrow-forward-outline"></ion-icon>\n\n            </span> -->\n\n            \n\n          </ion-col>\n\n        </ion-row>\n\n      </ion-grid>\n\n    </ion-card-header>\n\n\n\n    <div class="head">\n\n      <ion-row>\n\n        <ion-col col-4 text-left>PID</ion-col>\n\n        <ion-col col-8 text-left class="value">{{taskDetails?.pid}}</ion-col>\n\n      </ion-row>\n\n      <ion-row>\n\n        <ion-col col-4 text-left>{{\'WORKFLOW_DETAILS_PROCESS\' | translate}}</ion-col>\n\n        <ion-col col-8 text-left class="value">{{taskDetails?.processnametw}}</ion-col>\n\n      </ion-row>\n\n\n\n      <ion-row>\n\n        <ion-col col-4 text-left>{{\'WORKFLOW_DETAILS_TASK\' | translate}}</ion-col>\n\n        <ion-col col-8 text-left class="value">{{taskDetails?.taskdesctw}}</ion-col>\n\n      </ion-row>\n\n\n\n      <ion-row>\n\n        <ion-col col-4 text-left>{{\'WORKFLOW_DETAILS_APPLYMAN\' | translate}}</ion-col>\n\n        <ion-col col-8 text-left class="value">{{taskDetails?.ownername}}</ion-col>\n\n      </ion-row>\n\n\n\n      <ion-row>\n\n        <ion-col col-4 text-left>{{\'WORKFLOW_DETAILS_APPLYTIME\' | translate}}</ion-col>\n\n        <ion-col col-8 text-left class="value">{{taskDetails?.datecreated}}</ion-col>\n\n      </ion-row>\n\n    </div>\n\n  </ion-card>\n\n\n\n  <ion-card>\n\n    <ion-card-header>\n\n      <ion-grid>\n\n        <ion-row>\n\n          <ion-col col-auto align-self-center>\n\n            <ion-icon name="settings-outline"></ion-icon>\n\n            <span>{{\'WORKFLOW_DETAILS_MAININFO\' | translate}}</span>\n\n          </ion-col>\n\n        </ion-row>\n\n      </ion-grid>\n\n    </ion-card-header>\n\n\n\n    <div class="head">\n\n      <ion-row *ngFor="let item of Head">\n\n        <ion-col col-4 text-left>{{item.keyname}}</ion-col>\n\n        <ion-col col-8 text-left class="value" [innerHtml]="item.value"> </ion-col>\n\n      </ion-row>\n\n    </div>\n\n  </ion-card>\n\n\n\n  <ion-card>\n\n    <ion-card-header>\n\n      <ion-grid>\n\n        <ion-row>\n\n          <ion-col col-auto align-self-center>\n\n            <ion-icon name="list-box-outline"></ion-icon>\n\n            <span>{{\'WORKFLOW_DETAILS_DETAILINFO\' | translate}}({{formItems?.length}})</span>\n\n          </ion-col>\n\n        </ion-row>\n\n      </ion-grid>\n\n    </ion-card-header>\n\n    <ion-slides pager>\n\n      <ion-slide *ngFor="let items of formItems,let indx = index" [ngStyle]="slideWidth(indx)">\n\n        <div class="head">\n\n          <ion-row *ngFor="let item of items">\n\n            <ion-col col-4 text-left>{{item.keyname}}</ion-col>\n\n            <ion-col col-8 text-left class="value" [innerHtml]="item.value"></ion-col>\n\n          </ion-row>\n\n        </div>\n\n        <br />\n\n      </ion-slide>\n\n    </ion-slides>\n\n  </ion-card>\n\n\n\n  <ion-card>\n\n    <ion-card-header>\n\n      <ion-grid>\n\n        <ion-row>\n\n          <ion-col col-auto align-self-center>\n\n            <ion-icon name="book-outline"></ion-icon>\n\n            <span>{{\'WORKFLOW_DETAILS_CKECKHISTORY\' | translate}}</span>\n\n          </ion-col>\n\n        </ion-row>\n\n      </ion-grid>\n\n    </ion-card-header>\n\n    <ion-list no-lines>\n\n      <ion-item *ngFor="let item of ApprovalInfo">\n\n        <h4>{{item.completedate}}&nbsp;<span class="value">{{item.responsiblename}}</span></h4>\n\n        <p>{{item.taskdesctw}}</p>\n\n      </ion-item>\n\n    </ion-list>\n\n  </ion-card>\n\n\n\n  <!-- <div  > -->\n\n  <div *ngIf="flag == \'Y\' || isNeedSign">\n\n    <ion-card>\n\n      <ion-card-header>\n\n        <ion-grid>\n\n          <ion-row>\n\n            <ion-col col-auto align-self-center>\n\n              <ion-icon name="create-outline"></ion-icon>\n\n              <span>{{\'WORKFLOW_DETAILS_SIGN\' | translate}}</span>\n\n            </ion-col>\n\n          </ion-row>\n\n        </ion-grid>\n\n\n\n      </ion-card-header>\n\n      <ion-card-content>\n\n        <ion-textarea #nameInput [(ngModel)]="approval" placeholder="{{\'WORKFLOW_DETAILS_ALERT\' | translate}}">\n\n        </ion-textarea>\n\n      </ion-card-content>\n\n    </ion-card> \n\n  </div>\n\n \n\n</ion-content>\n\n<ion-footer>\n\n  <ion-toolbar>\n\n    <!-- flag: Y: 支持移动签核；C: 任务已完成； N,B: 不支持手机签核 \n\n    isNeedSign: 是否支持手机签章\n\n    当 flag 等于 Y ， 或者 （isNeedSign 等于 true 且 flag 不等于 C） 时，可以签章 -->\n\n\n\n    <div class="toolbar-button" *ngIf="!isLoadingData && (flag == \'Y\' || (isNeedSign && flag != \'C\') )">\n\n      <button ion-button round color="secondary" block (click)="adoptTask()">\n\n        {{\'WORKFLOW_DETAILS_ADOPT\' | translate}}\n\n      </button>\n\n      <button ion-button ion-end color="danger" round block (click)="rejectTask()">\n\n        {{\'WORKFLOW_DETAILS_REJECT\' | translate}}\n\n      </button>\n\n    </div>\n\n    <div text-center class="hints" *ngIf="!isLoadingData ">\n\n      <span *ngIf="flag == \'C\' "> {{\'WORKFLOW_DETAILS_TASK_FINISH\' | translate}} </span>  \n\n      <span *ngIf="(flag == \'N\' || flag == \'B\') && !isNeedSign  "> {{\'WORKFLOW_DETAILS_HINT\' | translate}} </span>\n\n    </div> \n\n  </ion-toolbar>\n\n</ion-footer>\n\n'/*ion-inline-end:"F:\iproud2.5-pwa\src\pages\workflow\workflow-details\workflow-details.html"*/,
        }),
...
//# sourceMappingURL=workflow-details.js.map
