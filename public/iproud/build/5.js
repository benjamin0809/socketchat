...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "WorkflowSettingAgentlistPageModule", function() { return WorkflowSettingAgentlistPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__workflow_setting_agentlist__ = __webpack_require__(1304);
...
var WorkflowSettingAgentlistPageModule = (function () {
    function WorkflowSettingAgentlistPageModule() {
    }
    WorkflowSettingAgentlistPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__workflow_setting_agentlist__["a" /* WorkflowSettingAgentlistPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["k" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__workflow_setting_agentlist__["a" /* WorkflowSettingAgentlistPage */]),
                __WEBPACK_IMPORTED_MODULE_3__ngx_translate_core__["b" /* TranslateModule */].forChild(),
                __WEBPACK_IMPORTED_MODULE_4__components_components_module__["a" /* ComponentsModule */]
            ],
        })
    ], WorkflowSettingAgentlistPageModule);
    return WorkflowSettingAgentlistPageModule;
}());

//# sourceMappingURL=workflow-setting-agentlist.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return WorkflowSettingAgentlistPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_workflow_provider__ = __webpack_require__(592);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__ngx_translate_core__ = __webpack_require__(29);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__workflow_tabs_workflow_common__ = __webpack_require__(1135);
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
...
/**
 * Generated class for the WorkflowSettingAgentlistPage page.
 *
 * See https://ionicframework.com/docs/components/#navigation for more info on
 * Ionic pages and navigation.
 */
var WorkflowSettingAgentlistPage = (function (_super) {
    __extends(WorkflowSettingAgentlistPage, _super);
    function WorkflowSettingAgentlistPage(navCtrl, workflowProvider, events, alertCtrl, translateService) {
        var _this = _super.call(this, navCtrl, events) || this;
        _this.navCtrl = navCtrl;
        ...
        _this.getMyAgent();
        _this.events.subscribe('set-agent-success', function () {
            _this.getMyAgent();
        });
        return _this;
    }
    WorkflowSettingAgentlistPage.prototype.doRefresh = function (refresher) {
        this.getMyAgent(refresher);
    };
    WorkflowSettingAgentlistPage.prototype.addAgent = function () {
        this.navCtrl.push('SetposterPage');
    };
    WorkflowSettingAgentlistPage.prototype.getMyAgent = function (refresher) {
        var _this = this;
        this.workflowProvider.getAgent().subscribe(function (data) {
            _super.prototype.completeRefresh.call(_this, refresher);
            _this.agentlist = data.result;
        }, function (err) {
            _super.prototype.completeRefresh.call(_this, refresher);
        });
    };
    WorkflowSettingAgentlistPage.prototype.deleteAgent = function (item) {
        this.showDeleteMsg(item);
    };
    WorkflowSettingAgentlistPage.prototype.showDeleteMsg = function (item) {
        var _this = this;
        var confirm = this.alertCtrl.create({
            title: this.translateService.instant('MESSAGE_DELETE_TITLE'),
            message: this.translateService.instant('AGENT_DELETE_MESSAGE'),
            buttons: [
                {
                ...
                },
                {
                    ...
                    handler: function () {
                        _this.agentGuid = item.rowguid;
                        _this.workflowProvider.deleteAgent(_this.agentGuid).subscribe(function (data) {
                            _this.getMyAgent();
                        });
                    }
                }
    ...
    WorkflowSettingAgentlistPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-workflow-setting-agentlist',template:/*ion-inline-start:"F:\iproud2.5-pwa\src\pages\workflow\workflow-setting-agentlist\workflow-setting-agentlist.html"*/'<!--\n\n  Generated template for the WorkflowSettingAgentlistPage page.\n\n\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n\n  Ionic pages and navigation.\n\n-->\n\n<ion-header >\n\n\n\n  <ion-navbar>\n\n    <ion-title>{{\'WORKFLOW_SETTING_AGENTLIST\'| translate}} </ion-title>\n\n  </ion-navbar>\n\n\n\n</ion-header>\n\n\n\n\n\n<ion-content  >\n\n    <ion-refresher (ionRefresh)="doRefresh($event)">\n\n        <ion-refresher-content pullingIcon="arrow-dropdown"  >\n\n        </ion-refresher-content>\n\n    </ion-refresher>\n\n\n\n    <data-hints text="{{\'WORKFLOW_AGENTLIST_HINT\' | translate}}" *ngIf="!agentlist||agentlist?.length == 0"></data-hints>\n\n\n\n \n\n\n\n  <ion-card *ngFor="let item of agentlist">\n\n      <ion-card-header>\n\n          {{item.orderno}}:\n\n      </ion-card-header>\n\n      <ion-card-content>\n\n          <P>{{\'WORKFLOW_SETTING_AGENTID\' | translate}}{{item.agentcode}}</P>\n\n          <P>{{\'WORKFLOW_SETTING_AGENTNAME\' | translate}}{{item.agentname}}</P>\n\n          <P>{{\'WORKFLOW_SETTING_AGENTTYPE\' | translate}}{{item.agenttype}}</P>\n\n          <P>{{\'WORKFLOW_SETTING_AGENTTIME\' | translate}}{{item.startdate}}{{\'WORKFLOW_SETTING_TILL\' | translate}}{{item.enddate}}</P>\n\n          <button ion-button small color="danger"   (click)="deleteAgent(item)">{{\'WORKFLOW_SETTING_DELETE\' | translate}}</button>\n\n      </ion-card-content>\n\n    </ion-card>\n\n \n\n</ion-content>\n\n<ion-footer >\n\n    <ion-toolbar> \n\n        <button ion-button block round color="primary" (click)="addAgent()"> {{\'WORKFLOW_SETTING_NEW\' | translate}}</button>\n\n    </ion-toolbar>\n\n</ion-footer>'/*ion-inline-end:"F:\iproud2.5-pwa\src\pages\workflow\workflow-setting-agentlist\workflow-setting-agentlist.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["p" /* NavController */],
            __WEBPACK_IMPORTED_MODULE_2__providers_workflow_provider__["a" /* WorkflowProvider */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* Events */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["b" /* AlertController */],
            __WEBPACK_IMPORTED_MODULE_3__ngx_translate_core__["c" /* TranslateService */]])
    ], WorkflowSettingAgentlistPage);
    return WorkflowSettingAgentlistPage;
}(__WEBPACK_IMPORTED_MODULE_4__workflow_tabs_workflow_common__["a" /* workflowCommon */]));

//# sourceMappingURL=workflow-setting-agentlist.js.map
