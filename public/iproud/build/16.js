...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "WidgetListPageModule", function() { return WidgetListPageModule; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__widget_list__ = __webpack_require__(1299);
...
var WidgetListPageModule = (function () {
    function WidgetListPageModule() {
    }
    WidgetListPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_4__widget_list__["a" /* WidgetListPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_2_ionic_angular__["k" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_4__widget_list__["a" /* WidgetListPage */]),
    ...
    ], WidgetListPageModule);
    return WidgetListPageModule;
}());

//# sourceMappingURL=widget-list.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return WidgetListPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
...
var WidgetListPage = (function () {
    function WidgetListPage(navCtrl, widgetProvider, cd, session, events, element) {
        var _this = this;
        this.navCtrl = navCtrl;
        ...
        if (this.session.widget) {
            this.createData(this.session.widget);
        }
        else {
            this._getAllWidget();
        }
        //变更语言更新
        events.subscribe('lang:changed', function (event) {
    ...
    */
    WidgetListPage.prototype.scrollWidth = function (width, height) {
        return {
            "width": width || (window.screen.availWidth - 5) + 'px',
            "height": (height || 36) + 'px',
        };
    };
    WidgetListPage.prototype.ngAfterViewChecked = function () {
        this._offsetTops = [];
        this._scrollHeight = 0;
        var categories = this.element.nativeElement.querySelectorAll(".category-box");
        if (!categories)
            return;
        for (var _i = 0, categories_1 = categories; _i < categories_1.length; _i++) {
            var element = categories_1[_i];
            var offsetTop = element.offsetTop;
            if (this._offsetTops.indexOf(offsetTop) == -1) {
                this._offsetTops.push(offsetTop);
            }
            this._scrollHeight += element.clientHeight;
        }
    ...
    WidgetListPage.prototype.getBottomBar = function () {
        var selectedEle = this.element.nativeElement.querySelector("#header-" + this.topId);
        if (!selectedEle) {
            return;
        }
        var width = selectedEle.clientWidth + 'px';
        return { 'transform': "translateX(" + selectedEle.offsetLeft + "px) ", 'width': width };
    };
    WidgetListPage.prototype.selectCategory = function (id) {
        this.topId = id;
        this.scrollTopByHandle();
    };
    // 用內部瀏覽器打開應用，附加AuthCode和語言代碼
    WidgetListPage.prototype.openWidget = function (widget) {
        var page = {
    ...
    WidgetListPage.prototype._getAllWidget = function () {
        var _this = this;
        this.widgetProvider.getAllWidget({ "lang": this.session.language }).subscribe(function (data) {
            if (data.errcode == 0) {
                _this.createData(data.result);
            }
        });
    };
    WidgetListPage.prototype.createData = function (datalist) {
        this.allCategories = [];
        var i = 0;
        if (!datalist)
            return;
        ...
        this.topId = this.allCategories.length > 0 ? this.allCategories[0]['id'] : '';
    };
    WidgetListPage.prototype.scrollTopByHandle = function () {
        if (!this.topId)
            return;
        var ele = this.element.nativeElement.querySelector("#" + this.topId);
        this.content.scrollTop = ele && ele.offsetTop;
    };
    /**
     * 根据Y轴scroll滚动百分比，控制X轴scrollLeft的值
     * @param left
     */
    WidgetListPage.prototype.scrollxTo = function (left) {
        if (left === void 0) { left = 0; }
        var target = this.scrollx._scrollContent.nativeElement;
        left = (target.scrollWidth - target.clientWidth) * this.content.scrollTop / (this._scrollHeight - this.content.contentHeight);
        target.scrollLeft = left;
    };
    WidgetListPage.prototype.scrollEvent = function (e) {
        var _this = this;
    ...
    */
    WidgetListPage.prototype.openWidgetUpdatePage = function () {
        this.navCtrl.push('WidgetAmendPage', {});
    };
    //下拉刷新
    WidgetListPage.prototype.doRefresh = function (refresh) {
        this._getAllWidget();
        setTimeout(function () {
            refresh.complete();
        }, 500);
    ...
    ], WidgetListPage.prototype, "content", void 0);
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["ViewChild"])('scroll'),
        __metadata("design:type", Object)
    ], WidgetListPage.prototype, "scrollx", void 0);
    WidgetListPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-widget-list',template:/*ion-inline-start:"F:\iproud2.5-pwa\src\pages\widget\widget-list\widget-list.html"*/'<ion-header >\n\n    <!-- \n\n        <ion-toolbar color="primary">\n\n            <ion-searchbar (input)="getItems($event)" placeholder="{{\'WIDGET_LIST_TITLE\' | translate}}"></ion-searchbar>\n\n        </ion-toolbar>\n\n    -->\n\n\n\n\n\n    <ion-navbar>\n\n        <ion-title>{{ \'WIDGET_LIST_TITLE\' | translate }}</ion-title>\n\n        <ion-buttons end>\n\n            <button ion-button icon-only (click)="openWidgetUpdatePage()">\n\n                <ion-icon name="ios-more"></ion-icon>\n\n            </button>\n\n        </ion-buttons>\n\n    </ion-navbar>\n\n    <ion-toolbar class="scroll-toolbar" *ngIf="allCategories && allCategories.length > 0"> \n\n        <ion-scroll #scroll scrollX="true" style="transition :all .5" [ngStyle]="scrollWidth()">\n\n          <div class="scrollx-container">\n\n            <span [id]=" \'header-\' + item.id" class="type" *ngFor="let item of allCategories,let indx = index" \n\n            (click)="selectCategory(item.id)" [ngClass]="{\'selected\': topId == item.id}" >\n\n            {{item.category}}\n\n          </span>\n\n          <div class="underline-box"  [ngStyle]="getBottomBar()">\n\n              <!-- <div class="underline"></div> -->\n\n          </div>\n\n          </div> \n\n        </ion-scroll> \n\n      </ion-toolbar>\n\n</ion-header>\n\n<ion-content (ionScroll)="scrollEvent($event)">\n\n        <!--下拉刷新 \n\n        refreshingSpinner= "circles"\n\n    -->\n\n    <ion-refresher (ionRefresh)="doRefresh($event)">   \n\n            <ion-refresher-content\n\n            pullingIcon = "arrow-dropdown"\n\n            pullingText = "{{\'HOME_PULL_REFRESH\' | translate }}"\n\n\n\n            refreshingText = "{{\'HOME_REFRESH\' | translate }}">\n\n            </ion-refresher-content>\n\n    </ion-refresher> \n\n        <div class="category-box" padding-top  [id]="categoryItem.id" *ngFor="let categoryItem of allCategories,let index = index" [ngClass]="index == allCategories.length-1 ? \'last-category\': \'\'">\n\n            <div class="category" text-left padding-left>\n\n                <ion-note color="medium">{{categoryItem.category}}</ion-note>\n\n            </div>\n\n            <ion-grid class="widgetlist">\n\n                <ion-row>\n\n                    <ion-col col-3 text-center *ngFor="let widget of categoryItem.widgets">\n\n                        <button text-center (click)="openWidget(widget)">\n\n                            <div class="bgimage">\n\n                                    <img-lazy-load [src]="widget.iconUrl"></img-lazy-load>\n\n                            </div>\n\n                            <!-- <img-lazy-load [src]="widget.iconUrl"></img-lazy-load> -->\n\n                            <!-- <img [src]="widget.iconUrl"/> --> \n\n                            <span class="widget-name">{{widget.widgetName}}</span> \n\n                        </button>\n\n                    </ion-col>\n\n                </ion-row>\n\n            </ion-grid>\n\n        </div>  \n\n   \n\n</ion-content>'/*ion-inline-end:"F:\iproud2.5-pwa\src\pages\widget\widget-list\widget-list.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["p" /* NavController */],
            __WEBPACK_IMPORTED_MODULE_2__providers_providers__["n" /* WidgetProvider */],
            __WEBPACK_IMPORTED_MODULE_0__angular_core__["ChangeDetectorRef"],
            __WEBPACK_IMPORTED_MODULE_3__services_services__["f" /* Session */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* Events */],
            __WEBPACK_IMPORTED_MODULE_0__angular_core__["ElementRef"]])
    ], WidgetListPage);
    return WidgetListPage;
}());

//# sourceMappingURL=widget-list.js.map
