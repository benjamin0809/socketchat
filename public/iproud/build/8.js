...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__donetask__ = __webpack_require__(1300);
...
var DonetaskPageModule = (function () {
    ...
    DonetaskPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__donetask__["a" /* DonetaskPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["k" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__donetask__["a" /* DonetaskPage */]),
...
//# sourceMappingURL=donetask.module.js.map
 ...
 */
var DonetaskPage = (function (_super) {
    __extends(DonetaskPage, _super);
    function DonetaskPage(navCtrl, navParams, events, workflowProvider, session) {
        var _this = _super.call(this, navCtrl, events) || this;
        _this.navCtrl = navCtrl;
     ...
     * @param _event 刷新事件
     */
    DonetaskPage.prototype.getFinishedTasks = function (_event) {
        var _this = this;
        this.workflowProvider.getFinishedTask(this.startDate, this.endDate).subscribe(function (data) {
    ...
    DonetaskPage.prototype.searchTask = function () {
        this.page = 0;
        this.createArray(true);
        this.tasklist = this.showlist;
    };
    DonetaskPage.prototype.getTaskListByDate = function () {
        var array = [];
        for (var _i = 0, _a = this.tasklist; _i < _a.length; _i++) {
            var item = _a[_i];
            if (item.datecreated <= this.endDate && item.datecreated >= this.startDate) {
                array.push(item);
            }
        }
        return array;
    ...
    /**调用父类返回方法 */
    DonetaskPage.prototype.goBack = function () {
        _super.prototype.goBack.call(this);
    };
    /**调用父类跳到任务详情方法 */
    DonetaskPage.prototype.goDetails = function (item) {
        item['app_isEdit'] = false;
        item['isFinished'] = true;
        _super.prototype.goDetails.call(this, item);
    };
    DonetaskPage.prototype.doRefresh = function (_event) {
        this.getFinishedTasks(_event);
    };
    //加载更多数据
    DonetaskPage.prototype.doInfinite = function (infiniteScroll) {
        this.createArray();
        setTimeout(function () {
    ...
    * 判断是否还有更多数据
    * */
    DonetaskPage.prototype.isMoreData = function () {
        var array = this.getTaskListByDate();
        if (array.length != this.showlist.length && array.length > 0) {
    ...
    //添加数据到临时数组
    DonetaskPage.prototype.createArray = function (isEmptyGroups) {
        if (isEmptyGroups) {
            this.showlist = [];
        }
        var start = this.page * this.count;
        var array = this.getTaskListByDate();
        for (var i = start; i < start + this.count && i < array.length; i++) {
            if (!this.showlist)
                this.showlist = [];
            this.showlist.push(array[i]);
        }
...
//# sourceMappingURL=donetask.js.map
