...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ClubAllPageModule", function() { return ClubAllPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__club_all__ = __webpack_require__(1218);
...
var ClubAllPageModule = (function () {
    function ClubAllPageModule() {
    }
    ClubAllPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [__WEBPACK_IMPORTED_MODULE_2__club_all__["a" /* ClubAllPage */]],
            imports: [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["k" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__club_all__["a" /* ClubAllPage */]), __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */]]
        })
    ], ClubAllPageModule);
    return ClubAllPageModule;
}());

//# sourceMappingURL=club-all.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ClubAllPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(13);
...
/**
 * Generated class for the ClubAllPage page.
 *
 * See https://ionicframework.com/docs/components/#navigation for more info on
 * Ionic pages and navigation.
 */
var ClubAllPage = (function () {
    function ClubAllPage(navCtrl, clubProvider, navParams) {
        this.navCtrl = navCtrl;
    ...
    ClubAllPage.prototype.ionViewDidLoad = function () {
        this.getAllClubs();
    };
    ClubAllPage.prototype.getAllClubs = function (_event) {
        this.allClubs = [];
    ...
    ClubAllPage.prototype.doRefresh = function (_event) {
        _event.complete();
        this.getAllClubs();
    };
    ClubAllPage.prototype.doInfinite = function (_event) {
        // this.clubProvider.getEvents(this.pageCount).subscribe(res => {
        //   this.hasMoreData = Math.floor(Math.random() * 10) % 3 != 1;
        //   this.allClubs.push.apply(this.allClubs, res);
        //   _event.complete();
        // });
    };
    ClubAllPage.prototype.openClub = function (club) {
        this.navCtrl.push("ClubDetailPage", club);
    };
    ClubAllPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: "page-club-all",template:/*ion-inline-start:"F:\iproud2.5-pwa\src\pages\community\club-all\club-all.html"*/'<!--\n\n  Generated template for the ClubAllPage page.\n\n\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n\n  Ionic pages and navigation.\n\n-->\n\n<ion-header>\n\n  <ion-navbar>\n\n    <ion-title>club-all</ion-title>\n\n  </ion-navbar>\n\n  <ion-searchbar\n\n    [(ngModel)]="searchText"\n\n    (ionInput)="getCurrentItems($event)"\n\n    (ionClear)="onClearFilter($event)"\n\n    placeholder="搜全部社团"\n\n  >\n\n  </ion-searchbar>\n\n\n\n  <ion-item no-lines>\n\n    <span item-start class="segment-title">全部社团（58）</span>\n\n    <ion-icon item-end name="menu" (click)="openModal()"></ion-icon>\n\n  </ion-item>\n\n</ion-header>\n\n\n\n<ion-content>\n\n  <ion-refresher (ionRefresh)="doRefresh($event)">\n\n    <ion-refresher-content pullingIcon="arrow-dropdown">\n\n    </ion-refresher-content>\n\n  </ion-refresher>\n\n\n\n  <iproud-load-data [isDataEmpty]="isDataEmpty" [isDataLoading]="isDataLoading">\n\n  </iproud-load-data>\n\n\n\n  <ion-list *ngIf="allClubs && allClubs.length > 0">\n\n    <ion-item *ngFor="let item of allClubs">\n\n      <ion-avatar item-start (click)="openClub(item)">\n\n        <img [src]="item.eventImage" />\n\n      </ion-avatar>\n\n      <h2>{{ item.clubName }}</h2>\n\n      <p>{{ item.eventPlace }}</p>\n\n      <ion-note item-end>\n\n        <button ion-button small outline class="button-outline-ios">\n\n          关注\n\n        </button>\n\n      </ion-note>\n\n    </ion-item>\n\n  </ion-list>\n\n\n\n  <ion-infinite-scroll *ngIf="hasMoreData" (ionInfinite)="doInfinite($event)">\n\n    <ion-infinite-scroll-content\n\n      aria-posinset="button"\n\n      loadingSpinner="bubbles"\n\n    >\n\n    </ion-infinite-scroll-content>\n\n  </ion-infinite-scroll>\n\n</ion-content>\n\n'/*ion-inline-end:"F:\iproud2.5-pwa\src\pages\community\club-all\club-all.html"*/
        }),
...
//# sourceMappingURL=club-all.js.map
