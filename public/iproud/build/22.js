...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ParkLifePageModule", function() { return ParkLifePageModule; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__parklife__ = __webpack_require__(1256);
...
var ParkLifePageModule = (function () {
    function ParkLifePageModule() {
    }
    ParkLifePageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_4__parklife__["a" /* ParkLifePage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_2_ionic_angular__["k" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_4__parklife__["a" /* ParkLifePage */]),
    ...
    return ParkLifePageModule;
}());

//# sourceMappingURL=parklife.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ParkLifePage; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__providers_content_provider__ = __webpack_require__(599);
...
var ParkLifePage = (function () {
    function ParkLifePage(navCtrl, session, storageService, translateService, nativeService, widgetProvider, contentProvider, navParams) {
        var _this = this;
        this.navCtrl = navCtrl;
        this.session = session;
        this.storageService = storageService;
        ...
        this.contentProvider.getParkLifeList().subscribe(function (data) {
            _this.items = data.result;
        });
    }
    ParkLifePage.prototype.ionViewDidLoad = function () {
    };
    ParkLifePage.prototype.gotoPark = function (item) {
    ...
    ParkLifePage.prototype.doRefresh = function (refresh) {
        var _this = this;
        this.contentProvider.getParkLifeList().subscribe(function (data) {
            _this.items = data.result;
            refresh.complete();
    ...
    ParkLifePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["Component"])({
            selector: 'page-parklife',template:/*ion-inline-start:"F:\iproud2.5-pwa\src\pages\home\parklife\parklife.html"*/'<ion-header >\n\n    <ion-navbar>\n\n        <ion-title>{{title}}</ion-title>\n\n    </ion-navbar>\n\n</ion-header>\n\n<ion-content>\n\n        <ion-refresher (ionRefresh)="doRefresh($event)">\n\n                <ion-refresher-content pullingIcon="arrow-dropdown" pullingText="{{\'HOME_PULL_REFRESH\' | translate }}"\n\n                  refreshingText="{{\'HOME_REFRESH\' | translate }}">\n\n                </ion-refresher-content>\n\n              </ion-refresher>\n\n    <ion-grid>\n\n        <ion-row>\n\n            <ion-col col-6 col-sm-6 col-md-6 col-lg-6 col-xl-6 *ngFor="let item of items">\n\n                <ion-card (click)="gotoPark(item)">\n\n                    <ion-card-content >\n\n                        <ion-card-title>{{item.displayName}}</ion-card-title>\n\n                        <!-- <img  src="{{item.iconUrl}}"/> -->\n\n                        <div class="bgimage">\n\n                                <img-lazy-load [src]="item.iconUrl"></img-lazy-load>\n\n                          </div> \n\n                    </ion-card-content>\n\n                </ion-card>\n\n            </ion-col>\n\n\n\n        </ion-row>\n\n    </ion-grid>\n\n\n\n</ion-content>\n\n'/*ion-inline-end:"F:\iproud2.5-pwa\src\pages\home\parklife\parklife.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_0_ionic_angular__["p" /* NavController */],
            ...
            __WEBPACK_IMPORTED_MODULE_5__providers_content_provider__["a" /* ContentProvider */],
            __WEBPACK_IMPORTED_MODULE_0_ionic_angular__["q" /* NavParams */]])
    ], ParkLifePage);
    return ParkLifePage;
}());

//# sourceMappingURL=parklife.js.map
