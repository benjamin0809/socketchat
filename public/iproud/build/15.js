...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "WorkflowAgentPageModule", function() { return WorkflowAgentPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__workflow_agent__ = __webpack_require__(1305);
...
var WorkflowAgentPageModule = (function () {
    function WorkflowAgentPageModule() {
    }
    WorkflowAgentPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__workflow_agent__["a" /* WorkflowAgentPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["k" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__workflow_agent__["a" /* WorkflowAgentPage */]),
                __WEBPACK_IMPORTED_MODULE_3__ngx_translate_core__["b" /* TranslateModule */].forChild(),
                __WEBPACK_IMPORTED_MODULE_4__components_components_module__["a" /* ComponentsModule */]
            ],
        })
    ], WorkflowAgentPageModule);
    return WorkflowAgentPageModule;
}());

//# sourceMappingURL=workflow-agent.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return WorkflowAgentPage; });
...
/**
 * Generated class for the WorkflowAgentPage page.
 *
 * See https://ionicframework.com/docs/components/#navigation for more info on
 * Ionic pages and navigation.
 */
var WorkflowAgentPage = (function () {
    function WorkflowAgentPage(navCtrl, navParams, events) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.events = events;
    }
    WorkflowAgentPage.prototype.ionViewDidLoad = function () {
    };
    WorkflowAgentPage.prototype.goBack = function () {
        this.events.publish('back-to-home');
    };
    WorkflowAgentPage.prototype.setPoster = function () {
        this.navCtrl.push('SetposterPage');
    };
    WorkflowAgentPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["Component"])({
            selector: 'page-workflow-agent',template:/*ion-inline-start:"F:\iproud2.5-pwa\src\pages\workflow\workflow-agent\workflow-agent.html"*/'<!--\n\n  Generated template for the WorkflowAgentPage page.\n\n\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n\n  Ionic pages and navigation.\n\n-->\n\n<ion-header  no-shadow>\n\n  <ion-navbar class="page-navbar" hideBackButton="true"  >\n\n    <ion-buttons start>\n\n      <button ion-button icon-only (click)="goBack()">\n\n        <ion-icon ios="ios-arrow-back" md="md-arrow-back"></ion-icon>\n\n      </button>\n\n    </ion-buttons>\n\n    <ion-title>{{\'WORKFLOW_AGENT_TITLE\' | translate}}</ion-title>\n\n  </ion-navbar>\n\n</ion-header>\n\n<ion-content>\n\n\n\n\n\n  <ion-card>\n\n    <ion-card-header>\n\n      <ion-grid>\n\n        <ion-row>\n\n          <ion-col col-auto align-self-center>\n\n            <ion-icon name="alert-outline"></ion-icon>\n\n            <span>{{\'WORKFLOW_AGENT_NOWAGENT\' | translate}}</span>\n\n          </ion-col>\n\n        </ion-row>\n\n      </ion-grid>\n\n    </ion-card-header>\n\n    <ion-card-content>\n\n\n\n\n\n      <button ion-button block (click)="setPoster()">{{\'WORKFLOW_AGENT_BUTTON\' | translate}}</button>\n\n    </ion-card-content>\n\n  </ion-card>\n\n\n\n</ion-content>\n\n'/*ion-inline-end:"F:\iproud2.5-pwa\src\pages\workflow\workflow-agent\workflow-agent.html"*/,
        }),
