...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "UndonetaskPageModule", function() { return UndonetaskPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__undonetask__ = __webpack_require__(1302);
...
var UndonetaskPageModule = (function () {
    function UndonetaskPageModule() {
    }
    UndonetaskPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__undonetask__["a" /* UndonetaskPage */]
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["k" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__undonetask__["a" /* UndonetaskPage */]),
                __WEBPACK_IMPORTED_MODULE_3__ngx_translate_core__["b" /* TranslateModule */].forChild(),
                __WEBPACK_IMPORTED_MODULE_4__components_components_module__["a" /* ComponentsModule */]
            ],
        })
    ], UndonetaskPageModule);
    return UndonetaskPageModule;
}());

//# sourceMappingURL=undonetask.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return UndonetaskPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__services_utility__ = __webpack_require__(32);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__workflow_tabs_workflow_common__ = __webpack_require__(1135);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_user_provider__ = __webpack_require__(92);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__providers_workflow_provider__ = __webpack_require__(592);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__services_constants__ = __webpack_require__(14);
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
...
/**
 * Generated class for the UndonetaskPage page.
 *
 * See https://ionicframework.com/docs/components/#navigation for more info on
 * Ionic pages and navigation.
 */
var UndonetaskPage = (function (_super) {
    __extends(UndonetaskPage, _super);
    function UndonetaskPage(navCtrl, navParams, events, session, workflowProvider, translate, popoverCtrl, userProvider) {
        var _this = _super.call(this, navCtrl, events) || this;
        _this.navCtrl = navCtrl;
        ...
        _this.isDataEmpty = false;
        _this.init();
        _this.events.subscribe('set-showmobiletask-success', function () {
            _this.getUndoneTasks();
        });
        _this.events.subscribe('workflow:refresh-todo-list', function () {
            _this.getUndoneTasks();
        });
        return _this;
    }
     ...
     * @param _event
     */
    UndonetaskPage.prototype.getUndoneTasks = function (_event) {
        var _this = this;
        if (!_event)
        ...
        this.tasklist = [];
        this.showlist = [];
        this.buttons.push({ appcode: '_iproud_all', modelname: '_all_models', modeldesc: this.translate.instant('WORKFLOW_UNDONETASK_ALL'), appname: this.translate.instant('WORKFLOW_UNDONETASK_ALL'), totalnum: 0, isSelected: true });
        this.currentModel = this.buttons[0].modelname;
        // this.mock()
        var ShowMobileTaskOnly = this.session.setting ? this.session.setting['showmobileTaskOnly'.toUpperCase()] : false;
        this.workflowProvider.getTodoTask(__WEBPACK_IMPORTED_MODULE_0__services_utility__["a" /* Utility */].boolean(ShowMobileTaskOnly)).subscribe(function (data) {
            if (data.result) {
                if (__WEBPACK_IMPORTED_MODULE_0__services_utility__["a" /* Utility */].boolean(ShowMobileTaskOnly)) {
                    _this.tasklist = data.result.Tasks.filter(function (task) { return task.flag > '0'; });
                }
                else {
                    _this.tasklist = data.result.Tasks;
                }
                for (var _i = 0, _a = _this.tasklist; _i < _a.length; _i++) {
                    var item = _a[_i];
                    if (item.flag > '0' || (item.signflag == 'Y' && __WEBPACK_IMPORTED_MODULE_8__services_constants__["o" /* ENABLE_ELECTRONIC_SIGNATURE */])) {
                        item.supportMobile = true;
                    }
                    else {
                        item.supportMobile = false;
                    }
                }
                _this.buttons = _this.buttons.concat(data.result.Models);
                for (var _b = 0, _c = _this.buttons; _b < _c.length; _b++) {
                    var button = _c[_b];
                    button.totalnum = 0;
                    for (var _d = 0, _e = _this.tasklist; _d < _e.length; _d++) {
                        var task = _e[_d];
                        if (button.modelname == task.modelname) {
                            button.totalnum++;
                        }
                    }
                    button.modeldesc = button.modeldesc || button.modeldesctw;
                }
                _this.buttons[0].totalnum = _this.tasklist.length;
                _this.buttons = _this.buttons.filter(function (a) {
                    return a.totalnum > 0;
                });
                _this.buttons.length > 0 ? _this.isDataEmpty = false : _this.isDataEmpty = true;
                _this.showlist = _this.tasklist;
    ...
    /**
     * 根據傳入model對象过滤任務列表
     * @param _item Model 對象
     */
    UndonetaskPage.prototype.getTasksByModel = function (_item) {
        this.currentModel = _item.modelname;
        this.showlist = [];
        if (_item.appcode == '_iproud_all') {
            this.showlist = this.tasklist;
        }
        else {
            for (var _i = 0, _a = this.tasklist; _i < _a.length; _i++) {
                var item = _a[_i];
                if (item.modelname == _item.modelname) {
    ...
    /**调用父类返回方法 */
    UndonetaskPage.prototype.goBack = function () {
        _super.prototype.goBack.call(this);
    };
    /**调用父类跳到任务详情方法 */
    UndonetaskPage.prototype.goDetails = function (item) {
        item['app_isEdit'] = item.flag > '0';
        item['app_needSign'] = true;
        _super.prototype.goDetails.call(this, item);
    };
    UndonetaskPage.prototype.scrollWidth = function () {
        return _super.prototype.scrollWidth.call(this, window.screen.availWidth - 25);
    };
    UndonetaskPage.prototype.doRefresh = function (_event) {
        this.getUndoneTasks(_event);
    };
    UndonetaskPage.prototype.init = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!this.session.setting) return [3 /*break*/, 1];
                        this.getUndoneTasks();
                        return [3 /*break*/, 3];
                    case 1: return [4 /*yield*/, this.userProvider.getPrivateSetting()];
                    case 2:
                        obersver = _a.sent();
                        obersver.subscribe(function (res) {
                            var setting = {};
                            for (var _i = 0, _a = res['result']; _i < _a.length; _i++) {
                                var item = _a[_i];
                                setting[item.name.toUpperCase()] = item.value;
                            }
                            _this.session.setting = setting;
                            _this.getUndoneTasks();
                        }, function (err) {
                            _this.getUndoneTasks();
                        });
    ...
    UndonetaskPage.prototype.mock = function () {
        for (var i = 0; i < 20; i++) {
            var str = "可能会是多少个汉字呢，你猜一下";
            var item = { appcode: '_iproud_all' + i,
                modelname: '_all_models' + i,
                modeldesctw: str.substr(i),
                appname: str.substr(i),
                totalnum: 0,
                isSelected: false };
    ...
    UndonetaskPage.prototype.changeButtonsShow = function () {
        this.isCollapse = !this.isCollapse;
        this.content.resize();
    };
    UndonetaskPage.prototype.scrollHeight = function () {
        var scrollHeight = this.taskType.nativeElement
            ? this.taskType.nativeElement.clientHeigh
                || this.taskType.nativeElement.offsetHeight
                || this.taskType.nativeElement.scrollHeight : 44;
        return {
            height: scrollHeight > 200 ? 200 : scrollHeight + 'px'
        };
    };
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_5__angular_core__["ViewChild"])(__WEBPACK_IMPORTED_MODULE_4_ionic_angular__["f" /* Content */]),
        __metadata("design:type", __WEBPACK_IMPORTED_MODULE_4_ionic_angular__["f" /* Content */])
    ], UndonetaskPage.prototype, "content", void 0);
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_5__angular_core__["ViewChild"])('taskType'),
        __metadata("design:type", Object)
    ], UndonetaskPage.prototype, "taskType", void 0);
    UndonetaskPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_5__angular_core__["Component"])({
            selector: 'page-undonetask',template:/*ion-inline-start:"F:\iproud2.5-pwa\src\pages\workflow\undonetask\undonetask.html"*/'<ion-header no-shadow>\n\n  <ion-navbar class="page-navbar" hideBackButton="true" >\n\n    <ion-buttons start>\n\n      <button ion-button icon-only (click)="goBack()">\n\n        <ion-icon ios="ios-arrow-back" md="md-arrow-back"></ion-icon>\n\n        {{\'HOME_TITLE\' | translate}}\n\n      </button>\n\n    </ion-buttons>\n\n    <ion-title>{{\'WORKFLOW_UNDONETASK_TITLE\' | translate}}</ion-title>\n\n    <!-- <ion-buttons end class="close-buttons">\n\n      <button ion-button icon-only (click)="goBack()">\n\n        <img class="close-button" src="assets/imgs/close_black_button.png">\n\n      </button>\n\n    </ion-buttons> -->\n\n  </ion-navbar>\n\n  <ion-toolbar *ngIf="buttons && buttons.length > 1">\n\n    <ion-scroll *ngIf="isCollapse" scrollX="true" [ngStyle]="scrollWidth()">\n\n      <div class="buttons-box">\n\n        <button class="type-button"ion-button small *ngFor="let item of buttons" (click)="getTasksByModel(item)" [color]="item.isSelected ? \'primary\':\'gray\'">{{item.modeldesc}}\n\n          <ion-badge item-end [color]="item.isSelected ? \'primary\':\'gray\'">{{item.totalnum}}</ion-badge>\n\n        </button>\n\n      </div>\n\n\n\n    </ion-scroll>\n\n\n\n    <div class="expand" #taskType *ngIf="!isCollapse"> \n\n      <button ion-button small *ngFor="let item of buttons" (click)="getTasksByModel(item)" [color]="item.isSelected ? \'primary\':\'gray\'">{{item.modeldesc}}\n\n        <ion-badge item-end [color]="item.isSelected ? \'primary\':\'gray\'">{{item.totalnum}}</ion-badge>\n\n      </button>\n\n    </div>\n\n    <div class="collapse" (click)="changeButtonsShow()">\n\n      <ion-icon name="ios-arrow-dropdown-outline" *ngIf="isCollapse"></ion-icon>\n\n      <ion-icon name="ios-arrow-dropup-outline" *ngIf="!isCollapse"></ion-icon>\n\n    </div>\n\n\n\n    \n\n  </ion-toolbar>\n\n</ion-header>\n\n\n\n\n\n<ion-content class="content-box">\n\n\n\n  <ion-refresher (ionRefresh)="doRefresh($event)">\n\n    <ion-refresher-content pullingIcon="arrow-dropdown" refreshingSpinner="circles">\n\n    </ion-refresher-content>\n\n  </ion-refresher>\n\n  \n\n  <nodata class="nodata" text="{{\'WORKFLOW_UNDONETASK_HINT\' | translate}}" *ngIf="isDataEmpty"></nodata>\n\n  <div text-center *ngIf="isDataLoading" padding>\n\n      <ion-spinner name="ios"></ion-spinner>\n\n    </div>\n\n  <ion-list>\n\n\n\n    <button *ngFor="let item of showlist" ion-item (click)="goDetails(item)">\n\n      <ion-avatar item-start *ngIf="item.supportMobile">\n\n        <img src="assets/img/workflow/mobilesupport.png">\n\n      </ion-avatar>\n\n      <ion-avatar item-start *ngIf="!item.supportMobile">\n\n        <img src="assets/img/workflow/mobilenotsupport.png">\n\n      </ion-avatar>\n\n      <h2 class="list-title">\n\n        {{item.processname}}\n\n      </h2>\n\n      <p class="taskdesc-box">\n\n        <span class="taskdesc">{{item.taskdesc}}</span>\n\n        <span class="pid">{{item.pid}}</span> \n\n      </p>\n\n      <p>\n\n        <span class="taskdate">{{item.ownername}}&nbsp; &nbsp; {{item.datecreated}}</span>\n\n      </p>\n\n\n\n    </button>\n\n\n\n  </ion-list>\n\n\n\n  <!-- <data-hints text="{{\'MESSAGE_NO_MORE\' | translate}}" *ngIf="!finiteScroll && page > 0"></data-hints> -->\n\n  <!-- \n\n  <ion-infinite-scroll *ngIf="finiteScroll" (ionInfinite)="doInfinite($event)">\n\n    <ion-infinite-scroll-content aria-posinset="button" loadingSpinner="bubbles">\n\n    </ion-infinite-scroll-content>\n\n  </ion-infinite-scroll> -->\n\n</ion-content>\n\n'/*ion-inline-end:"F:\iproud2.5-pwa\src\pages\workflow\undonetask\undonetask.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_4_ionic_angular__["p" /* NavController */],
            ...
            __WEBPACK_IMPORTED_MODULE_7__providers_workflow_provider__["a" /* WorkflowProvider */],
    ...
    return UndonetaskPage;
}(__WEBPACK_IMPORTED_MODULE_1__workflow_tabs_workflow_common__["a" /* workflowCommon */]));

//# sourceMappingURL=undonetask.js.map
