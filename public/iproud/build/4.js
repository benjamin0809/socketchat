...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "WorkflowSettingPageModule", function() { return WorkflowSettingPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__workflow_setting__ = __webpack_require__(1306);
...
var WorkflowSettingPageModule = (function () {
    function WorkflowSettingPageModule() {
    }
    WorkflowSettingPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__workflow_setting__["a" /* WorkflowSettingPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["k" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__workflow_setting__["a" /* WorkflowSettingPage */]),
                __WEBPACK_IMPORTED_MODULE_3__ngx_translate_core__["b" /* TranslateModule */].forChild(),
                __WEBPACK_IMPORTED_MODULE_4__components_components_module__["a" /* ComponentsModule */]
            ],
        })
    ], WorkflowSettingPageModule);
    return WorkflowSettingPageModule;
}());

//# sourceMappingURL=workflow-setting.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return WorkflowSettingPage; });
...
/**
 * Generated class for the WorkflowSettingPage page.
 *
 * See https://ionicframework.com/docs/components/#navigation for more info on
 * Ionic pages and navigation.
 */
var WorkflowSettingPage = (function (_super) {
    __extends(WorkflowSettingPage, _super);
    function WorkflowSettingPage(navCtrl, navParams, workflowProvider, storageService, userProvider, events, session) {
        var _this = _super.call(this, navCtrl, events) || this;
        _this.navCtrl = navCtrl;
    ...
    WorkflowSettingPage.prototype.ionViewDidLoad = function () {
    };
    /**调用父类返回方法 */
    WorkflowSettingPage.prototype.goBack = function () {
        _super.prototype.goBack.call(this);
    };
    WorkflowSettingPage.prototype.openMyAgent = function () {
        this.navCtrl.push('WorkflowSettingAgentlistPage');
    };
    WorkflowSettingPage.prototype.getSetting = function () {
        this.ReceiveMsgFromWF = this.session.setting['RECEIVEMSGFROMWF'.toUpperCase()];
        this.ShowMobileTaskOnly = this.session.setting['SHOWMOBILETASKONLY'.toUpperCase()];
    };
    WorkflowSettingPage.prototype.init = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                this.userProvider.getPrivateSetting().subscribe(function (res) {
                    var setting = {};
    ...
    /**
     * 保存更改设置，定时为3s后保存，以免用户反复操作
     * @param type 更改设置类型：message为是否接收消息，mobile为是否只显示手机签核
     */
    WorkflowSettingPage.prototype.changeSetting = function (type) {
        var _this = this;
        clearTimeout(this.timer);
        this.timer = setTimeout(function () {
            var changeValue = {};
            if ('message' == type) {
                changeValue = { "name": "ReceiveMsgFromWF", "value": _this.ReceiveMsgFromWF.toString() };
            }
            else if ('mobile' == type) {
                changeValue = { "name": "ShowMobileTaskOnly", "value": _this.ShowMobileTaskOnly.toString() };
                _this.session.setting['SHOWMOBILETASKONLY'.toUpperCase()] = _this.ShowMobileTaskOnly;
                _this.events.publish('set-showmobiletask-success');
            }
            _this.userProvider.privateSetting([changeValue]).subscribe(function (data) {
            });
        }, 1500);
    };
    WorkflowSettingPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["Component"])({
            selector: 'page-workflow-setting',template:/*ion-inline-start:"F:\iproud2.5-pwa\src\pages\workflow\workflow-setting\workflow-setting.html"*/' \n\n<ion-header  no-shadow>\n\n<ion-navbar class="page-navbar" hideBackButton="true"  >\n\n  <ion-buttons start>\n\n    <button ion-button icon-only (click)="goBack()">\n\n      <ion-icon ios="ios-arrow-back" md="md-arrow-back"></ion-icon>\n\n      {{\'HOME_TITLE\' | translate}}\n\n    </button>\n\n  </ion-buttons>\n\n  <ion-title>{{\'WORKFLOW_SETTING_TITLE\' | translate}}</ion-title>\n\n  <!-- <ion-buttons end class="close-buttons">\n\n    <button ion-button icon-only (click)="goBack()">\n\n      <img class="close-button" src="assets/imgs/close_black_button.png">\n\n    </button>\n\n  </ion-buttons> -->\n\n</ion-navbar>\n\n</ion-header>\n\n<ion-content> \n\n  <ion-list>\n\n      <ion-item>\n\n          <ion-label>{{\'WORKFLOW_SETTING_MESSAGE\' | translate}}</ion-label>\n\n          <ion-toggle color="primary" [(ngModel)]="ReceiveMsgFromWF" (ngModelChange)="changeSetting(\'message\')" ></ion-toggle>\n\n      </ion-item>\n\n    \n\n      <ion-item>\n\n          <ion-label>{{\'WORKFLOW_SETTING_TASK\' | translate}}</ion-label>\n\n          <ion-toggle color="primary"  [(ngModel)]="ShowMobileTaskOnly" (ngModelChange)="changeSetting(\'mobile\')" ></ion-toggle>\n\n      </ion-item> \n\n        <button class="agent-container" class="agent" ion-item (click)="openMyAgent()" no-lines>\n\n          {{\'WORKFLOW_SETTING_MYAGENT\' | translate}}\n\n        </button> \n\n  </ion-list>\n\n \n\n</ion-content>\n\n'/*ion-inline-end:"F:\iproud2.5-pwa\src\pages\workflow\workflow-setting\workflow-setting.html"*/,
        }),
