...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MyCommentPageModule", function() { return MyCommentPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__my_comment__ = __webpack_require__(1233);
...
var MyCommentPageModule = (function () {
    function MyCommentPageModule() {
    }
    MyCommentPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [__WEBPACK_IMPORTED_MODULE_2__my_comment__["a" /* MyCommentPage */]],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["k" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__my_comment__["a" /* MyCommentPage */]),
                __WEBPACK_IMPORTED_MODULE_3__ngx_translate_core__["b" /* TranslateModule */].forChild(),
                __WEBPACK_IMPORTED_MODULE_4__components_components_module__["a" /* ComponentsModule */]
            ]
        })
    ], MyCommentPageModule);
    return MyCommentPageModule;
}());

//# sourceMappingURL=my-comment.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return MyCommentPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(13);
 ...
 */
var MyCommentPage = (function () {
    function MyCommentPage(navCtrl, session, clubProvider, navParams) {
        this.navCtrl = navCtrl;
        this.session = session;
    ...
    MyCommentPage.prototype.ionViewDidLoad = function () {
        this.getMyComments();
    };
    MyCommentPage.prototype.getMyComments = function (_event) {
        this.myComments = [];
    ...
    MyCommentPage.prototype.doRefresh = function (_event) {
        _event.complete();
        this.getMyComments();
    };
    MyCommentPage.prototype.doInfinite = function (_event) {
        // this.clubProvider.getEvents(this.pageCount).subscribe(res => {
        //   this.hasMoreData = Math.floor(Math.random() * 10) % 3 != 1;
        //   this.myComments.push.apply(this.myComments, res);
        //   _event.complete();
        // });
    };
    MyCommentPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: "page-my-comment",template:/*ion-inline-start:"F:\iproud2.5-pwa\src\pages\community\my\my-comment\my-comment.html"*/'<!--\n\n  Generated template for the MyCommentPage page.\n\n\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n\n  Ionic pages and navigation.\n\n-->\n\n<ion-header>\n\n  <ion-navbar>\n\n    <ion-title>my-comment</ion-title>\n\n  </ion-navbar>\n\n  <ion-item no-lines>\n\n    <span item-start class="segment-title">全部(24)</span>\n\n    <ion-icon name="menu" item-end></ion-icon>\n\n  </ion-item>\n\n</ion-header>\n\n\n\n<ion-content>\n\n  <div class="divider"></div>\n\n  <ion-refresher (ionRefresh)="doRefresh($event)">\n\n    <ion-refresher-content pullingIcon="arrow-dropdown">\n\n    </ion-refresher-content>\n\n  </ion-refresher>\n\n\n\n  <iproud-load-data [isDataEmpty]="isDataEmpty" [isDataLoading]="isDataLoading">\n\n  </iproud-load-data>\n\n\n\n  <ion-list>\n\n    <div *ngFor="let item of myComments">\n\n      <ion-item no-lines>\n\n        <ion-avatar item-start>\n\n          <img [src]="currentUser?.pictureUrl" />\n\n        </ion-avatar>\n\n        <h4 class="title">\n\n          {{ currentUser?.nickName || currentUser?.userName }}\n\n        </h4>\n\n        <p>{{ item.eventTime }}</p>\n\n        <ion-note item-end\n\n          ><button class="button" ion-button small outline>\n\n            删除\n\n          </button></ion-note\n\n        >\n\n      </ion-item>\n\n      <span class="my-comment"\n\n        ><ion-icon name="paper-plane"></ion-icon>&nbsp;&nbsp;{{\n\n          item.eventPlace\n\n        }}</span\n\n      >\n\n\n\n      <ion-item class="post">\n\n        <ion-thumbnail item-start>\n\n          <img [src]="item.eventImage" />\n\n        </ion-thumbnail>\n\n        <h4>{{ item.eventPlace }}</h4>\n\n        <p>{{ item.clubName }}</p>\n\n      </ion-item>\n\n      <div class="divider"></div>\n\n      <br />\n\n    </div>\n\n  </ion-list>\n\n\n\n  <ion-infinite-scroll *ngIf="hasMoreData" (ionInfinite)="doInfinite($event)">\n\n    <ion-infinite-scroll-content\n\n      aria-posinset="button"\n\n      loadingSpinner="bubbles"\n\n    >\n\n    </ion-infinite-scroll-content>\n\n  </ion-infinite-scroll>\n\n</ion-content>\n\n'/*ion-inline-end:"F:\iproud2.5-pwa\src\pages\community\my\my-comment\my-comment.html"*/
        }),
...
//# sourceMappingURL=my-comment.js.map
