...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Search__ = __webpack_require__(1259);
...
var SearchPage = (function () {
    function SearchPage(navCtrl, authProvider, widgetProvider, session, translateService, storageService, events) {
        var _this = this;
        this.navCtrl = navCtrl;
        ...
        this.events.subscribe('user:logined', function (time) {
            _this.SearchInfo(_this.inputValue.trim());
        });
    }
    //开启页面获取焦点
    SearchPage.prototype.ionViewDidLoad = function () {
        // setTimeout(() => {
        //   this.keywordInput._searchbarInput.nativeElement.focus();
        // }, 1000); 
    };
    //离开页面时透明input
    ...
    SearchPage.prototype.ionViewDidEnter = function () {
        var _this = this;
        setTimeout(function () {
            _this.keywordInput._searchbarInput.nativeElement.focus();
            ; //为输入框设置焦点
        }, 150);
    };
    //输入数据实时调用
    ...
    //根据历史记录搜索
    SearchPage.prototype.getSearch = function (e) {
        this.finiteScroll = true;
        this.inputValue = e;
        this.pageIndex = 0;
        this.searchList = [];
        this.SearchInfo(this.inputValue);
    };
    //记录搜索的历史记录
    SearchPage.prototype.addHistory = function (historyNew) {
        //找到相同值的index
        var index = this.historyList.findIndex(function (p) { return p == historyNew; });
        if (index > -1) {
            //找到相同的值，先删除掉，再插入到第0位
            this.historyList.splice(index, 1);
        }
        //插入到第0位
        this.historyList.unshift(historyNew);
        //搜索记录只保留最后10条
        if (this.historyList.length > 10) {
            this.historyList.splice(10, 1);
        }
        this.historyRecord = this.historyList;
        this.storageService.setItem("HistorySearch", this.historyList);
    };
    //搜索集
    SearchPage.prototype.SearchInfo = function (keyword) {
        var _this = this;
        if (keyword) {
            this.addHistory(keyword);
            this.isShowRecord = false;
            this.seartchText = keyword;
            this.isLoading = true;
            this.widgetProvider.getSearch({
                "keyword": keyword,
                "skip": this.pageIndex,
                "take": this.pageNumber
            }).subscribe(function (data) {
                _this.isLoading = false;
                if (data.errcode == 0) {
                    _this.pageSum = data.result.totalCount;
                    for (var info in data.result.items) {
                        _this.searchList.push(data.result.items[info]);
                    }
                    if (_this.pageSum == _this.searchList.length) {
                        //搜索结果已经全部输出
                        // let more = {
                        //   "id": 0,
                        //   "type": null,
                        //   "title": "<div class='pageEnd'>" + this.translateService.instant('HOME_SEARCH_PERIOD') + "</div>",
                        //   "description": null,
                        //   "imageUrl": null,
                        //   "url": null,
                        //   "remark": null
    ...
    //应用跳转
    SearchPage.prototype.openArticle = function (article) {
        if (article == undefined || article == null || article.id == 0)
            return;
        var page = {
            url: article.url,
            title: article.type,
    ...
    SearchPage.prototype.doInfinite = function (infiniteScroll) {
        ...
        this.SearchInfo(this.seartchText);
        setTimeout(function () {
            infiniteScroll.complete();
        }, 1000);
    };
    SearchPage.prototype.clearAllHistory = function () {
        this.historyRecord = [];
        this.historyList = [];
        this.storageService.setItem("HistorySearch", this.historyList);
    };
    SearchPage.prototype.init = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.storageService.getItem("HistorySearch")];
                    case 1:
                        history = _a.sent();
                        if (history) {
    ...
    __decorate([
        ...
        __metadata("design:type", Object)
    ], SearchPage.prototype, "keywordInput", void 0);
    SearchPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_2_ionic_angular__["j" /* IonicPage */])(),
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-search',template:/*ion-inline-start:"F:\iproud2.5-pwa\src\pages\home\search\search.html"*/'<ion-header  no-border>\n\n  <ion-navbar> \n\n      <ion-searchbar color="primary" #keyword  [ngStyle]="{\'opacity\':isShowInput ? 1 : 0 }"\n\n      (ionInput)="getItems($event)" \n\n      [(ngModel)]="inputValue" \n\n      placeholder="{{\'HOME_SEARCH_INFO\' | translate}}"\n\n      [debounce]="debounce">\n\n    </ion-searchbar> \n\n    <ion-buttons end>\n\n      <button ion-button icon-only (click)="SearchInfo()">\n\n        {{\'HOME_SEARCH_LIST\' | translate}}\n\n      </button>\n\n    </ion-buttons>\n\n  </ion-navbar>\n\n</ion-header>\n\n\n\n<ion-content fullscreen scroll="false">\n\n  <div>\n\n    <ion-grid class="record" *ngIf="isShowRecord">\n\n      <ion-list>\n\n        <ion-list-header>\n\n          <h2>{{\'HOME_SEARCH_RECORD\' | translate}} </h2>\n\n          <ion-icon *ngIf="historyRecord && historyRecord.length > 0" item-end name="ios-trash-outline" (click)="clearAllHistory()"></ion-icon>\n\n        </ion-list-header>\n\n        <ion-item *ngIf="historyRecord && historyRecord.length > 0">\n\n          <ion-row>\n\n            <ion-col col-auto *ngFor="let recordInfo of historyRecord">\n\n              <button ion-button   color="gray"   round (click)="getSearch(recordInfo)">{{recordInfo}}</button>\n\n            </ion-col>\n\n          </ion-row>\n\n        </ion-item>\n\n      </ion-list>\n\n    </ion-grid>\n\n    <ion-grid class="record" *ngIf="!isShowRecord">\n\n      <ion-list> \n\n        <ion-list-header>\n\n          <h2>{{\'HOME_SEARCH_RESULT\' | translate}} &nbsp; {{pageSum}}&nbsp;{{\'HOME_SEARCH_ITEM\' |\n\n              translate}} </h2>\n\n        </ion-list-header>\n\n        <div text-center *ngIf="isLoading" padding>\n\n          <ion-spinner name="ios"></ion-spinner>\n\n        </div>\n\n        <ion-card *ngFor="let news of searchList " (click)="openArticle(news)">\n\n          <ion-item>\n\n            <img item-end *ngIf="news.imageUrl" [src]="news.imageUrl">\n\n            <!-- <img item-end   src="assets/img/avatar.png"> -->\n\n            <h2 [innerHTML]="news.title"></h2>\n\n            <p><span *ngIf="news.typeName">{{news.typeName}}</span> <span class="date">{{news.remark}}</span></p>\n\n          </ion-item>\n\n          <ion-card-content *ngIf="news.description">\n\n\n\n            <p [innerHTML]="news.description"></p>\n\n          </ion-card-content>\n\n        </ion-card>\n\n\n\n        <data-hints text="{{\'HOME_SEARCH_PERIOD\' | translate}}" *ngIf="!finiteScroll && true"></data-hints>\n\n\n\n      </ion-list>\n\n    </ion-grid>\n\n  </div>\n\n\n\n  <!-- 上滑的时候,加载数据 -->\n\n  <ion-infinite-scroll *ngIf="finiteScroll" (ionInfinite)="doInfinite($event)" threshold="100px">\n\n    <ion-infinite-scroll-content aria-posinset="button" loadingSpinner="bubbles" loadingText="{{\'HOME_SEARCH_LOADING\' | translate}}">\n\n    </ion-infinite-scroll-content>\n\n  </ion-infinite-scroll>\n\n</ion-content>\n\n'/*ion-inline-end:"F:\iproud2.5-pwa\src\pages\home\search\search.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2_ionic_angular__["p" /* NavController */],
