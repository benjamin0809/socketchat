...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__black_list__ = __webpack_require__(1244);
...
var BlackListPageModule = (function () {
    function BlackListPageModule() {
    }
    BlackListPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__black_list__["a" /* BlackListPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["k" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__black_list__["a" /* BlackListPage */]),
...
//# sourceMappingURL=black-list.module.js.map
...
var BlackListPage = (function () {
    function BlackListPage(navCtrl, navParams, alertCtrl, translateService, sqliteProvider, contactProvider, events) {
        this.navCtrl = navCtrl;
    ...
    BlackListPage.prototype.ionViewDidLoad = function () {
        ...
        this.sqliteProvider.queryContacts().subscribe(function (friends) {
            ...
            for (var _i = 0, friends_1 = friends; _i < friends_1.length; _i++) {
                ...
                if (JSON.parse(friend.Extra).isBlack == true) {
                    _this.blacklist.push(JSON.parse(friend.Extra));
                }
            }
            _this.blacklist.length == 0 ? _this.isDataEmpty = true : _this.isDataEmpty = false;
        }, function (err) {
            _this.isDataLoading = false;
        });
    };
    BlackListPage.prototype.doRefresh = function ($event) {
        var _this = this;
        this.isDataLoading = true;
        this.contactProvider.BlackList().subscribe(function (res) {
            _this.isDataLoading = false;
            _this.blacklist = res.result;
            res.result.length == 0 ? _this.isDataEmpty = true : _this.isDataEmpty = false;
            for (var _i = 0, _a = _this.blacklist; _i < _a.length; _i++) {
                var item = _a[_i];
                item.avator = item.avator || __WEBPACK_IMPORTED_MODULE_0__services_constants__["i" /* DEFAULT_AVATAR */];
    ...
    BlackListPage.prototype.openContactDetails = function (contact) {
        console.log(contact);
        this.navCtrl.push('ContactDetailPage', { friendId: contact.id }); //contact.memberId
    };
    BlackListPage.prototype.showDeleteMsg = function (contact) {
        var _this = this;
        var confirm = this.alertCtrl.create({
            title: "",
            message: this.translateService.instant('CONTACT_BLACK_LIST_REMOVE_MESSAGE'),
            buttons: [
                {
                ...
                },
                {
                    ...
                    handler: function () {
                        _this.removeFromBackList(contact);
                    }
                }
            ]
        });
    ...
    BlackListPage.prototype.removeFromBackList = function (contact) {
        var _this = this;
        this.contactProvider.RemoveFromBlackList(contact.id).subscribe(function () {
            contact.isBlack = false;
            _this.sqliteProvider.updateContact(contact).subscribe();
            var friends = {
                GroupId: contact.friendTagId,
                FriendId: contact.id,
                IsStar: (contact.IsStar || contact.isStar) ? 1 : 0,
                Extra: contact
            };
            _this.sqliteProvider.saveContact(friends).subscribe(function (res) {
                _this.events.publish('contact: refresh-friendsFromSqlite');
            });
            _this.contactProvider.BlackList().subscribe(function (res) {
                _this.blacklist = res.result;
                _this.blacklist.length == 0 ? _this.isDataEmpty = true : _this.isDataEmpty = false;
            });
        });
    ...
    BlackListPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_2__angular_core__["Component"])({
            selector: 'page-black-list',template:/*ion-inline-start:"F:\iproud2.5-pwa\src\pages\contact\black-list\black-list.html"*/'<!--\n\n  Generated template for the BlackListPage page.\n\n\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n\n  Ionic pages and navigation.\n\n-->\n\n<ion-header>\n\n\n\n  <ion-navbar>\n\n    <ion-title>{{\'CONTACT_BLACK_LIST_TITLE\'|translate}}</ion-title>\n\n    <!--\n\n    <ion-buttons end>\n\n        <button ion-button icon-only (click)="isSelect = !isSelect">\n\n          Edit\n\n        </button>\n\n    </ion-buttons> -->\n\n  </ion-navbar>\n\n\n\n  \n\n</ion-header>\n\n\n\n\n\n<ion-content  >\n\n    <ion-refresher (ionRefresh)="doRefresh($event)">\n\n        <ion-refresher-content pullingIcon="arrow-dropdown"  >\n\n        </ion-refresher-content>\n\n      </ion-refresher>\n\n  <ion-list>\n\n  <nodata text="{{\'APP_COMMON_NODATA\' | translate}}" translateKey="APP_COMMON_NODATA" *ngIf="isDataEmpty && !isDataLoading"></nodata>\n\n  <ion-item-sliding *ngFor="let contact of blacklist">\n\n    <ion-item (click)="openContactDetails(contact);"> \n\n      <ion-avatar item-start >\n\n          <img [src]="contact.avator" >\n\n      </ion-avatar>\n\n      <ion-label>{{contact.name}}</ion-label> \n\n    </ion-item>\n\n    <ion-item-options>\n\n        <button ion-button color="danger" (click)="showDeleteMsg(contact)">{{\'CONTACT_BLACK_LIST_REMOVE\'|translate}}</button>\n\n    </ion-item-options>\n\n  </ion-item-sliding>\n\n  </ion-list>\n\n\n\n  <!--<ion-list *ngIf="isSelect">\n\n    <ion-item *ngFor="let contact of blacklist"> \n\n        <ion-avatar item-start>\n\n            <img [src]="contact.avator">\n\n          </ion-avatar>\n\n        <ion-label>{{contact.name}}</ion-label> \n\n        <ion-checkbox [(ngModel)]="pepperoni"></ion-checkbox>\n\n      </ion-item>\n\n \n\n  </ion-list>-->\n\n</ion-content>\n\n'/*ion-inline-end:"F:\iproud2.5-pwa\src\pages\contact\black-list\black-list.html"*/,
        }),
...
//# sourceMappingURL=black-list.js.map
