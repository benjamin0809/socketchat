...
var ForgotPasswordPage = (function () {
    function ForgotPasswordPage(navCtrl, modalCtrl, authProvider, userProvider, toastCtrl, translateService, storageService, nativeService, countryProvider, navParams, viewCtrl, events, cacheProvider) {
        var _this = this;
        this.navCtrl = navCtrl;
        ...
        this.switch = false;
        this.COUNTDOWN_KEY = 'quickLoginCountDown'; //倒计时KEY
        ...
        if (this.navParams.data.mobile) {
            this.account.mobilephone = this.navParams.data.mobile;
        }
        this.storageService.getItem("country").then(function (country) {
            if (country) {
                if (countryProvider.getHots().findIndex(function (p) { return p.number == country.replace("+", ""); }) > -1) {
                    _this.account.country = country;
                }
                else {
                    _this.account.country = '+' + countryProvider.getHots()[0].number;
                }
            }
            else {
    ...
    ForgotPasswordPage.prototype.doSelectCountry = function () {
        var _this = this;
    ...
    ForgotPasswordPage.prototype.doForgotPassword = function () {
        var _this = this;
        //注册
        this.authProvider.onteLogin(this.account).subscribe(function (data) {
            ...
            var SetPasswordPage = _this.modalCtrl.create('SetPasswordPage');
            SetPasswordPage.present();
            SetPasswordPage.onDidDismiss(function () {
                _this.events.publish('closemodal:login-success');
            });
        }, function (err) {
            switch (err.errcode) {
                case 6120:
                    _this.signupErrorString = "LOGIN_ERROR_INCORRECT_PASSWORD";
                    break;
                case 6111:
                    _this.signupErrorString = "LOGIN_ERROR_PHONE_NUMBER_NOT_EXIST";
                    break;
                case 6100:
                    _this.signupErrorString = "ACCOUNT_LOCKED";
                    break;
                case 6126:
                    _this.signupErrorString = "LOGIN_ERROR_INCORRECT_SECURITY_CODE";
                    break;
                default:
                    _this.signupErrorString = 'LOGIN_ERROR';
            }
            _this.nativeService.alert(_this.translateService.instant(_this.signupErrorString));
        });
    };
    ForgotPasswordPage.prototype.sendSecurityCodeBefore = function () {
        var _this = this;
    ...
    ForgotPasswordPage.prototype._resetTime = function (time) {
        var that = this;
   ...
   * 判断按钮是否可用；
   * 1.手机号码为空时，所有按钮不可用。
   * 2.当手机号码部位空时，发送验证码按钮可用；验证码为6位时且同意协议时，下一步按钮可用。
   */
    ForgotPasswordPage.prototype.validateInput = function () {
    ...
    ForgotPasswordPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_2__angular_core__["Component"])({
            selector: 'page-forgot-password',template:/*ion-inline-start:"F:\iproud2.5-pwa\src\pages\account\forgot-password\forgot-password.html"*/'<ion-header >\n\n  <ion-navbar hideBackButton="true">\n\n      <ion-buttons start>\n\n          <button ion-button icon-only (click)="goBack()">\n\n            <ion-icon ios="ios-arrow-back" md="md-arrow-back"></ion-icon>\n\n          </button>\n\n        </ion-buttons>\n\n    <ion-title>{{ \'LOGIN_RETRIEVE_PASSWORD\' | translate }}</ion-title>\n\n  </ion-navbar>\n\n</ion-header>\n\n<ion-content>\n\n  <div margin></div>\n\n  <form (submit)="doForgotPassword()">\n\n    <div padding text-center><h1>\n\n        {{ \'FORGOT_PASSWORD_MOBILEPHONE\' | translate }}\n\n    </h1></div>\n\n\n\n    <div class="account-container"> \n\n    <ion-grid>\n\n      <ion-row align-self-center>\n\n        <ion-col col-3 class="line_label selectcountry" text-right>\n\n          <button type="button" ion-button outline clear icon-right color="primary" (click)="doSelectCountry()">{{account.country}}\n\n            <ion-icon name="md-arrow-dropdown"></ion-icon>\n\n          </button>\n\n        </ion-col>\n\n        <ion-col col-9 class="line_input"  >\n\n          <ion-input type="text" name="mobilephone" placeholder="{{ \'FORGOT_PASSWORD_MOBILEPHONE\' | translate }}" [(ngModel)]="account.mobilephone" (ngModelChange)="validateInput($event)"></ion-input>\n\n        </ion-col>\n\n      </ion-row>\n\n    </ion-grid>\n\n \n\n    <ion-grid>\n\n      <ion-row  >\n\n        <!-- <ion-col col-3 class="line_label verifycode">\n\n          <ion-label color="primary" text-right>{{ \'SIGNUP_VERIFYCODE\' | translate }}</ion-label>\n\n        </ion-col> -->\n\n        <ion-col col-8 class="line_input password"  >\n\n          <ion-input type="verifyCode" [(ngModel)]="account.verifyCode" (ngModelChange)="validateInput($event)" name="verifycode" placeholder="{{ \'SIGNUP_VERIFYCODE_PLACEHOLDER\' | translate }}"></ion-input>\n\n        </ion-col>\n\n        <ion-col col-4 class="line_label  ">\n\n          <button type="button" [disabled]="verifyButtonEnabled" ion-button outline small icon-right color="primary" (click)="sendSecurityCodeBefore()">{{ verifyButtonText }}</button>\n\n          <!--<button type="button" clear="{{verifyButtonEnabled}}" ion-button small outline icon-right color="primary" (click)="getVerifyCode()">{{ \'SIGNUP_VERIFYCODE_SEND\' | translate }} </button>-->\n\n\n\n        </ion-col>\n\n      </ion-row>\n\n    </ion-grid>\n\n    </div>\n\n    <div padding>\n\n      <button type="submit" [disabled]="!switch" ion-button color="primary" block>{{ \'FORGOT_PASSWORD_NEXTSTEP\' | translate }}</button>\n\n    </div>\n\n\n\n    <privacy-policy float="true" agreeText="{{ \'SIGNUP_LOGIN_AGREE_PRIVACY\' | translate }}" language="{{language}}"></privacy-policy>\n\n  </form>\n\n</ion-content>\n\n'/*ion-inline-end:"F:\iproud2.5-pwa\src\pages\account\forgot-password\forgot-password.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["p" /* NavController */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["n" /* ModalController */],
            __WEBPACK_IMPORTED_MODULE_4__providers_providers__["a" /* AuthProvider */],
            __WEBPACK_IMPORTED_MODULE_4__providers_providers__["m" /* UserProvider */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["x" /* ToastController */],
            __WEBPACK_IMPORTED_MODULE_3__ngx_translate_core__["c" /* TranslateService */],
            __WEBPACK_IMPORTED_MODULE_5__services_services__["g" /* StorageService */],
            __WEBPACK_IMPORTED_MODULE_5__services_services__["e" /* NativeService */],
            __WEBPACK_IMPORTED_MODULE_4__providers_providers__["f" /* CountryProvider */],
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__forgot_password__ = __webpack_require__(1173);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var ForgotPasswordPageModule = (function () {
    ...
    ForgotPasswordPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_4__forgot_password__["a" /* ForgotPasswordPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_3_ionic_angular__["k" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_4__forgot_password__["a" /* ForgotPasswordPage */]),
                __WEBPACK_IMPORTED_MODULE_2__ngx_translate_core__["b" /* TranslateModule */].forChild(),
