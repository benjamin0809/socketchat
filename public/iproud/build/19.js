...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__my_info__ = __webpack_require__(1284);
...
var MyInfoPageModule = (function () {
    ...
    MyInfoPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_3__my_info__["a" /* MyInfoPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_2_ionic_angular__["k" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_3__my_info__["a" /* MyInfoPage */]),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__providers_preload_provider__ = __webpack_require__(211);
...
var MyInfoPage = (function () {
    function MyInfoPage(navCtrl, modalCtrl, actionSheetCtrl, nativeService, userProvider, session, translateService, events, camera, faceService, preload) {
        var _this = this;
        this.navCtrl = navCtrl;
        ...
        this.fromLibraryText = "From Photo Library";
        this.fromCameraText = "Take Photo";
        ...
        if (this.session.user != null) {
            ...
            /*
            if (this.currentUser.pictureUrl == null || this.currentUser.pictureUrl == "") {
              this.currentUser.pictureUrl = "../../assets/img/avatar.png";
            }*/
        }
        this.translateService.get(['MY_INFO_FROM_LIBRARY', 'MY_INFO_FROM_CAMERA', 'MY_INFO_CANCEL']).subscribe(function (values) {
            _this.fromLibraryText = values['MY_INFO_FROM_LIBRARY'];
            _this.fromCameraText = values['MY_INFO_FROM_CAMERA'];
            _this.cancelText = values['MY_INFO_CANCEL'];
        });
        //當用戶信息變更時，接收廣播
        events.subscribe('user:info-changed', function (time) {
            _this.currentUser = _this.session.user;
        });
    }
    MyInfoPage.prototype.processWebImage = function (event) {
        var _this = this;
        ...
        for (var _i = 0, filesList_1 = filesList; _i < filesList_1.length; _i++) {
            ...
            reader.onload = function (readerEvent) {
                ...
                _this.getPictureSuccess(imageData);
            };
            reader.readAsDataURL(file);
        }
    };
    //头像上传
    MyInfoPage.prototype.uploadAvatar = function () {
        var _this = this;
        var that = this;
        that.actionSheetCtrl.create({
            buttons: [
                {
                    text: this.translateService.instant('MY_INFO_VIEW_FULL_AVATAR'),
                    handler: function () {
                        _this.preload.previewImage([{
                                pictureUrl: _this.currentUser.pictureUrl
                            }], 0);
                    }
                },
                {
                    text: this.fromLibraryText,
                    handler: function () {
                        if (_this.nativeService.isMobile()) {
                            that.nativeService.getPictureByPhotoLibrary({
    ...
    MyInfoPage.prototype.getPictureSuccess = function (img) {
        this.userProvider.uploadAvatar(img);
    };
    //修改昵称
    MyInfoPage.prototype.openNick = function () {
        this.navCtrl.push('updataNickNamePage', this.currentUser);
    };
    //修改电话
    MyInfoPage.prototype.openPhone = function () {
        this.navCtrl.push('updataPhonePage');
    };
    MyInfoPage.prototype.openSignature = function () {
        this.navCtrl.push('UpdateSignaturePage');
    };
    MyInfoPage.prototype.openScancode = function () {
        this.navCtrl.push('MycodePage');
    };
    MyInfoPage.prototype.goBindEmployee = function () {
        this.navCtrl.push("EmployeeIdentityPage");
        //this.navCtrl.push('EmployeeIdentityPage');
    };
    MyInfoPage.prototype.goChangePassword = function () {
        this.navCtrl.push("ChangePasswordPage");
    };
    MyInfoPage.prototype.goSetPassword = function () {
        this.navCtrl.push("SetPasswordPage");
    };
    //测试MD5
    MyInfoPage.prototype.goMD5 = function () {
        //str : any;
        //let text = Md5.hashStr(this.str);
        //console.log("MD5加密前：",this.str);
        //console.log("MD5加密一次后：",text);
        //text = Md5.hashStr(text.toString());
        //console.log("MD5加密二次后：",text);
        var obj = this.faceService.Detect("");
    };
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["ViewChild"])('fileInput'),
        __metadata("design:type", Object)
    ], MyInfoPage.prototype, "fileInput", void 0);
    MyInfoPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["Component"])({
            selector: 'page-my-info',template:/*ion-inline-start:"F:\iproud2.5-pwa\src\pages\my\my-info\my-info.html"*/'<ion-header>\n\n  <ion-navbar>\n\n    <ion-title>{{\'MY_INFO_TITLE\' | translate}}</ion-title>\n\n  </ion-navbar>\n\n</ion-header>\n\n<ion-content>\n\n  <ion-list>\n\n      <input type="file" #fileInput   style="visibility: hidden; height: 0px;position: absolute;" name="files[]" (change)="processWebImage($event)" />\n\n    <button ion-item (click)="uploadAvatar()">\n\n      <h2>{{\'MY_INFO_AVATAR\' | translate}}</h2>\n\n      <ion-avatar item-end>\n\n        <!-- <img [src]="currentUser.pictureUrl"> --> \n\n        <img-lazy-load  [src]="currentUser.pictureUrl"></img-lazy-load>\n\n      </ion-avatar>\n\n    </button>\n\n    <button ion-item (click)="openNick()">\n\n      <h2>{{\'MY_INFO_NICKNAME\' | translate}}</h2>\n\n      <ion-note item-end>{{currentUser.nickName}}\n\n      </ion-note>\n\n    </button>\n\n    <button ion-item (click)="openPhone()">\n\n      <h2>{{\'MY_INFO_USERNAME\' | translate}}</h2>\n\n      <ion-note item-end>{{currentUser.userName}}\n\n      </ion-note>\n\n    </button>\n\n    <!-- <button ion-item (click)="openSignature()">\n\n      <h2>{{\'MY_INFO_SIGNATURE\' | translate}}</h2>\n\n      <ion-note item-end>{{currentUser.signature}}\n\n      </ion-note>\n\n    </button> -->\n\n    <!-- <button ion-item (click)="openScancode()">\n\n        <h2>{{\'MY_INFO_CODE\' | translate}}</h2>\n\n        <ion-note item-end><img [src]="currentUser?.scanCode">\n\n        </ion-note>\n\n      </button> -->\n\n  </ion-list> \n\n\n\n  <div padding  >\n\n    <button ion-button (click)="goBindEmployee()"  *ngIf="!currentUser.isEmployee" block round color="primary">\n\n      {{\'MY_INFO_BIND_EMPLOYEE\' | translate}}\n\n    </button>\n\n\n\n    <button ion-button (click)="goSetPassword()" *ngIf="!currentUser.hasPassword"  block round color="medium">\n\n      {{\'MY_INFO_SET_PASSWORD\' | translate}}\n\n    </button>\n\n\n\n    <button ion-button block round color="primary"  *ngIf="currentUser.isEmployee" (click)="goBindEmployee()">\n\n        {{\'MY_INFO_SHOW_EMPLOYEE\' | translate}}\n\n      </button>\n\n      <button ion-button block round color="medium"  *ngIf="currentUser.hasPassword" (click)="goChangePassword()">\n\n        {{\'MY_INFO_CHANGE_PASSWORD\' | translate}}\n\n      </button>\n\n  </div>\n\n   \n\n</ion-content>\n\n'/*ion-inline-end:"F:\iproud2.5-pwa\src\pages\my\my-info\my-info.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2_ionic_angular__["p" /* NavController */],
            __WEBPACK_IMPORTED_MODULE_2_ionic_angular__["n" /* ModalController */],
            ...
            __WEBPACK_IMPORTED_MODULE_6__services_services__["a" /* FaceService */],
            __WEBPACK_IMPORTED_MODULE_0__providers_preload_provider__["a" /* PreloadProvider */]])
    ], MyInfoPage);
    return MyInfoPage;
}());
