...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "WfLoginPageModule", function() { return WfLoginPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__wf_login__ = __webpack_require__(1180);
...
var WfLoginPageModule = (function () {
    function WfLoginPageModule() {
    }
    WfLoginPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__wf_login__["a" /* WfLoginPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["k" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__wf_login__["a" /* WfLoginPage */]),
                __WEBPACK_IMPORTED_MODULE_4__ngx_translate_core__["b" /* TranslateModule */].forChild(),
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */]
            ],
        })
    ], WfLoginPageModule);
    return WfLoginPageModule;
}());

//# sourceMappingURL=wf-login.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return WfLoginPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
...
var WfLoginPage = (function () {
    function WfLoginPage(navCtrl, authProvider, translateService, session, events, nativeService, storageService, ionicApp, vctrl, modalCtrl, viewCtrl) {
        var _this = this;
        this.navCtrl = navCtrl;
        ...
        this.loginWay = 'mobile';
        this.validateInput();
        /**
         * 登录成功处理
         */
        this.events.subscribe('LoginByWFAccount2:success', function (resp) {
            _this.loginSuccess(resp);
        });
    }
    WfLoginPage.prototype.ionViewDidLoad = function () {
        var _this = this;
        this.storageService.getItem("language").then(function (language) {
            _this.language = language;
        });
        this.storageService.getItem("account").then(function (account) {
            _this.account.account = account;
        });
    };
    // Attempt to login in through our User service
    WfLoginPage.prototype.doLogin = function () {
        this.LoginByWFAccountBefore();
    };
    WfLoginPage.prototype.validateInput = function () {
        if ((this.account.account.length > 0) && (this.account.password.length > 0)) {
     ...
     * 登录前先进行验证码校验
     */
    WfLoginPage.prototype.LoginByWFAccountBefore = function () {
        var _this = this;
        this.loginEnabled = false;
        this.account['lang'] = this.session.language;
        this.account['clientId'] = this.account.account;
        this.authProvider.sendSecurityCodeBefore('LoginByWFAccountBefore', this.account, this.vctrl.id, function () {
     ...
     * 登录
     */
    WfLoginPage.prototype.LoginByWFAccount = function () {
        var _this = this;
        this.authProvider.LoginByWFAccount({
     ...
     * @param resp
     */
    WfLoginPage.prototype.loginSuccess = function (resp) {
        this.storageService.setItem("account", this.account.account);
        // this.events.publish('extra-login-success')
        // this.vctrl.dismiss();
    };
    WfLoginPage.prototype.goBack = function () {
        this.viewCtrl.dismiss();
    };
    WfLoginPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-wf-login',template:/*ion-inline-start:"F:\iproud2.5-pwa\src\pages\account\wf-login\wf-login.html"*/'<ion-header >\n\n    <ion-navbar hideBackButton="true">\n\n        <ion-buttons start>\n\n            <button ion-button icon-only (click)="goBack()">\n\n              <ion-icon ios="ios-arrow-back" md="md-arrow-back"></ion-icon>\n\n            </button>\n\n          </ion-buttons>\n\n      <ion-title>{{ \'LOGIN_WORKFLOW\' | translate }}</ion-title>\n\n    </ion-navbar>\n\n  </ion-header>\n\n  <ion-content>\n\n       \n\n        <div class="tips">\n\n          <p>{{ \'LOGIN_BY_WORKFLOW_TIPS\' | translate }}</p>\n\n        </div>\n\n      <form (submit)="doLogin()">\n\n        <ion-grid class="login" >\n\n          <ion-row> \n\n            <ion-col col-12 class="line_input" ion-item>\n\n              <ion-input type="text" name="workflowaccount" placeholder="{{ \'LOGIN_ACCOUNT\' | translate }}" [(ngModel)]="account.account" (ngModelChange)="validateInput()"></ion-input>\n\n            </ion-col>\n\n          </ion-row>\n\n        </ion-grid>\n\n      \n\n        \n\n        <ion-grid>\n\n          <ion-row>\n\n            <!-- <ion-col col-3 class="line_label password">\n\n              <ion-label color="primary" text-right>{{ \'LOGIN_PASSWORD\' | translate }}</ion-label>\n\n            </ion-col> -->\n\n            <ion-col col-12 class="line_input" ion-item>\n\n              <ion-input type="password" [(ngModel)]="account.password" (ngModelChange)="validateInput()" name="password" placeholder="{{ \'LOGIN_PASSWORD\' | translate }}"></ion-input>\n\n            </ion-col>\n\n          </ion-row>\n\n        </ion-grid>\n\n        <ion-grid>\n\n          <ion-row>\n\n            <ion-col col-12 class="line_label">\n\n              <button type="submit" [disabled]="!loginEnabled" ion-button color="primary"  block>{{ \'LOGIN_SUBMIT\' | translate }}</button>\n\n            </ion-col>\n\n          </ion-row>\n\n         \n\n        </ion-grid>\n\n      </form>\n\n \n\n      \n\n        <privacy-policy float="true" agreeText="{{ \'SIGNUP_LOGIN_AGREE_PRIVACY\' | translate }}" language="{{language}}"></privacy-policy>\n\n  </ion-content> \n\n'/*ion-inline-end:"F:\iproud2.5-pwa\src\pages\account\wf-login\wf-login.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2_ionic_angular__["p" /* NavController */],
            __WEBPACK_IMPORTED_MODULE_3__providers_providers__["a" /* AuthProvider */],
            ...
            __WEBPACK_IMPORTED_MODULE_4__services_services__["g" /* StorageService */],
...
//# sourceMappingURL=wf-login.js.map
