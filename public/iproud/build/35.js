...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AchieveTaskListPageModule", function() { return AchieveTaskListPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__achieve_task_list__ = __webpack_require__(1182);
...
var AchieveTaskListPageModule = (function () {
    function AchieveTaskListPageModule() {
    }
    AchieveTaskListPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__achieve_task_list__["a" /* AchieveTaskListPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_4__components_components_module__["a" /* ComponentsModule */],
                __WEBPACK_IMPORTED_MODULE_3__ngx_translate_core__["b" /* TranslateModule */],
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["k" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__achieve_task_list__["a" /* AchieveTaskListPage */]),
            ],
        })
    ], AchieveTaskListPageModule);
    return AchieveTaskListPageModule;
}());

//# sourceMappingURL=achieve-task-list.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return AchieveTaskListPage; });
...
/**
 * Generated class for the AchieveTaskListPage page.
 *
 * See https://ionicframework.com/docs/components/#navigation for more info on
 * Ionic pages and navigation.
 */
var AchieveTaskListPage = (function () {
    function AchieveTaskListPage(navCtrl, navParams, element, cd, modal, nativeService, socialProvider, translate, events, session) {
        this.navCtrl = navCtrl;
        ...
        this.smallFontSize = false;
        this.smallFontSize = !(/zh/i.test(this.session.language));
        this.getTaskList();
    }
    AchieveTaskListPage.prototype.ionViewDidLoad = function () {
    };
    AchieveTaskListPage.prototype.ngAfterViewChecked = function () {
        var _this = this;
        this._offsetTops = [];
        this._offsetLefts = [];
        this.taskList.forEach(function (element) {
            var offsetTop = _this.element.nativeElement.querySelector("#" + element['elementId']).offsetTop;
            var offsetLeft = _this.element.nativeElement.querySelector("#scroll-" + element['elementId']).offsetLeft;
            if (_this._offsetTops.indexOf(offsetTop) == -1) {
                _this._offsetTops.push(offsetTop);
            }
            if (_this._offsetLefts.indexOf(offsetLeft) == -1) {
                _this._offsetLefts.push(offsetLeft);
            }
        });
    };
    AchieveTaskListPage.prototype.receiveAll = function () {
    };
    AchieveTaskListPage.prototype._createData = function () {
        for (var _i = 0, _a = this.taskList; _i < _a.length; _i++) {
            var item = _a[_i];
            item.elementId = 'taskId' + item.id;
            this._ids.push(item.elementId);
        }
        this.topId = this.taskList.length > 0 ? this.taskList[0]['elementId'] : '';
        this.content.resize();
    };
    AchieveTaskListPage.prototype.selectScrollXItem = function (id) {
        this.topId = id;
        this.scrollTopByHandle();
    };
    AchieveTaskListPage.prototype.scrollTopByHandle = function () {
        if (!this.topId)
            return;
        var ele = this.element.nativeElement.querySelector("#" + this.topId);
        this.content.scrollTop = ele.offsetTop;
    };
    AchieveTaskListPage.prototype.scrollxToLeft = function (left) {
        if (left === void 0) { left = 0; }
        this.scrollx._scrollContent.nativeElement.scrollLeft = left > 150 ? left - 150 : 0;
    };
    AchieveTaskListPage.prototype.scrollEvent = function (e) {
        var _this = this;
        var scrollTopOffsetTop = this.content.scrollTop + 30;
        this._offsetTops.forEach(function (v, i) {
            if (scrollTopOffsetTop >= v) {
                if (_this._offsetTops[i + 1]) {
                    if (scrollTopOffsetTop <= _this._offsetTops[i + 1]) {
                        _this.topId = _this._ids[i];
                        _this.scrollxToLeft(_this._offsetLefts[i]);
                    }
                }
                else {
                    _this.topId = _this._ids[i];
  ...
  */
    AchieveTaskListPage.prototype.scrollWidth = function (width, height) {
        return {
            "width": width || (window.screen.availWidth - 5) + 'px',
            "minHeight": 36 + 'px'
        };
    };
    AchieveTaskListPage.prototype.openAchieve = function (item) {
        var md = this.modal.create('AchieveItemPage', item, {
            enterAnimation: 'modal-scale-enter',
            leaveAnimation: 'modal-scale-leave'
        });
        md.present();
    };
    AchieveTaskListPage.prototype.receiveReward = function (id) {
        var _this = this;
        this.socialProvider.TakeScore(id).subscribe(function (res) {
            if (res.errcode == 0) {
                // this.nativeService.showToast(`${this.translate.instant('SOCIAL_TASK_RECEIVE')}${res.result.score}${this.translate.instant('SOCIAL_IPROUD_POINTS')}${this.translate.instant('SOCIAL_TASK_COMPLETED')}`)
                _this.getTaskList();
                _this.events.publish('achievement:refresh-assets');
            }
        });
    };
    AchieveTaskListPage.prototype._canReceivePoints = function () {
        for (var _i = 0, _a = this.taskList; _i < _a.length; _i++) {
            var tasks = _a[_i];
            for (var _b = 0, _c = tasks.tasks; _b < _c.length; _b++) {
                var item = _c[_b];
                if (item.isFinished && !item.isTakeScore)
                    return true;
            }
        }
        return false;
    };
    AchieveTaskListPage.prototype.getTaskList = function () {
        var _this = this;
        this.socialProvider.getTasks().subscribe(function (res) {
            _this.taskList = res.result;
            _this.isCanReceive = _this._canReceivePoints();
            for (var _i = 0, _a = _this.taskList; _i < _a.length; _i++) {
                var tasks = _a[_i];
                tasks.tasks.sort(function (a, b) {
                    if (a.isFinished && !a.isTakeScore) {
                        return -1;
                    }
                    if (a.isFinished == b.isFinished) {
                        return b.isComplete ? 1 : 0 - a.isComplete ? 1 : 0;
                    }
                    return b.isTakeScore ? 1 : 0 - a.isTakeScore ? 1 : 0;
                });
            }
            _this._createData();
        });
    ...
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_4__angular_core__["ViewChild"])(__WEBPACK_IMPORTED_MODULE_5_ionic_angular__["f" /* Content */]),
        __metadata("design:type", __WEBPACK_IMPORTED_MODULE_5_ionic_angular__["f" /* Content */])
    ], AchieveTaskListPage.prototype, "content", void 0);
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_4__angular_core__["ViewChild"])('scroll'),
        __metadata("design:type", Object)
    ], AchieveTaskListPage.prototype, "scrollx", void 0);
    AchieveTaskListPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_4__angular_core__["Component"])({
            selector: 'page-achieve-task-list',template:/*ion-inline-start:"F:\iproud2.5-pwa\src\pages\achievement\achieve-task-list\achieve-task-list.html"*/'<ion-header>\n\n\n\n    <ion-navbar>\n\n      <ion-title>{{\'SOCIAL_TASK_TITLE\' | translate}}</ion-title>\n\n      \n\n    </ion-navbar>\n\n    <ion-toolbar class="scroll-toolbar" *ngIf="taskList && taskList.length > 0"> \n\n        <ion-scroll #scroll scrollX="true" [ngStyle]="scrollWidth()">\n\n          <div class="scrollx-container">\n\n            <span [id]="\'scroll-\' + item.elementId" class="type" *ngFor="let item of taskList,let indx = index" \n\n            (click)="selectScrollXItem(item.elementId)" [ngClass]="{\'selected\': topId == item.elementId}" >\n\n            {{item.description}}\n\n          </span>\n\n          </div> \n\n        </ion-scroll> \n\n      </ion-toolbar>\n\n  </ion-header>\n\n  \n\n  \n\n  <ion-content (ionScroll)="scrollEvent($event)">\n\n      <div class="container" [id]="task.elementId" *ngFor="let task of taskList,let index = index" [ngClass]="index == taskList.length-1 ? \'last-item\': \'\'">\n\n            \n\n          <div class="achievelist" *ngFor="let taskItem of task.tasks,let itemindx = index">  \n\n\n\n            <!-- <ion-grid>\n\n              <ion-row>\n\n                <ion-col>\n\n                    <span class="title">\n\n                        <span>{{taskItem.name}}</span>\n\n                        <img *ngIf="taskItem.isFinished" class="complete"src="assets/img/correct_red.png"></span> \n\n                </ion-col>\n\n\n\n                <ion-col >\n\n                    <button ion-button small color="medium" [outline]="!taskItem.isFinished" [disabled]="!taskItem.isFinished" *ngIf="!taskItem.isFinished">\n\n                        <img class="gray" src="assets/img/points.png">\n\n                          {{taskItem.awardScore}}\n\n                        </button>\n\n                        <button ion-button small  [disabled]="!taskItem.isFinished" *ngIf="!taskItem.isTakeScore && taskItem.isFinished" (click)="receiveReward(taskItem.id)">\n\n                          {{\'SOCIAL_TASK_RECEIVE\' | translate}}<img src="assets/img/points.png">{{taskItem.awardScore}}\n\n                        </button>\n\n                        <button ion-button small color="medium" [outline]="taskItem.isTakeScore" [disabled]="taskItem.isTakeScore" *ngIf="taskItem.isTakeScore">\n\n                            <img src="assets/img/points.png">{{taskItem.awardScore}} \n\n                        </button>\n\n                  </ion-col>\n\n              </ion-row>\n\n            </ion-grid> -->\n\n \n\n              <!-- <ion-item  >\n\n                  <span class="title">\n\n                      <span>{{taskItem.name}}</span>\n\n                      <img *ngIf="taskItem.isFinished" class="complete"src="assets/img/correct_red.png"></span> \n\n                      <ion-note item-end>\n\n                          <button class="" ion-button small color="medium" [outline]="!taskItem.isFinished" [disabled]="!taskItem.isFinished" *ngIf="!taskItem.isFinished || taskItem.isTakeScore">\n\n                              <img class="gray" src="assets/img/points.png">\n\n                                {{taskItem.awardScore}}\n\n                              </button>\n\n                              <button ion-button small  *ngIf="!taskItem.isTakeScore && taskItem.isFinished" (click)="receiveReward(taskItem.id)">\n\n                                {{\'SOCIAL_TASK_RECEIVE\' | translate}}<img src="assets/img/points.png">{{taskItem.awardScore}}\n\n                              </button> \n\n                      </ion-note>\n\n                </ion-item> -->\n\n              \n\n            <div class="achievelist-item">\n\n             \n\n\n\n              <div class="item-content">\n\n                <span class="title" [ngClass]="{\'small-title\': smallFontSize}"> \n\n                  <img  class="complete" [src]="taskItem.isFinished ? \'assets/img/achievement/correct_red.png\' : \'assets/img/achievement/circle.png\'"></span> \n\n                  <span>{{taskItem.name}}</span> \n\n                <span class="item-button">\n\n                 <!-- 已完成;已领取 -->\n\n                    <button class="button-width " text-right ion-button small style="opacity: .4 !important"  disabled *ngIf="taskItem.isFinished && taskItem.isTakeScore">\n\n                      <img class="coins" src="assets/img/points.png">\n\n                        {{taskItem.awardScore}}\n\n                      </button>\n\n\n\n                       <!-- 已完成;未领取 -->\n\n                      <button class="button-width canReceive"  ion-button small outline    *ngIf="taskItem.isFinished && !taskItem.isTakeScore" \n\n                      (click)="receiveReward(taskItem.id)" > \n\n                        <img class="coins" src="assets/img/points.png">\n\n                        {{taskItem.awardScore}}\n\n                      </button> \n\n\n\n                      <!-- 未完成 --> \n\n                      <button class="button-width " color="medium" ion-button small outline   *ngIf="!taskItem.isFinished" disabled  > \n\n                        <img class="coins gray" src="assets/img/points.png">{{taskItem.awardScore}}\n\n                      </button> \n\n                </span>\n\n              </div>\n\n             \n\n            </div>\n\n            \n\n            </div>\n\n            <div class="divider header-title" *ngIf="index != taskList.length-1" >  </div>\n\n          <!-- <div class="divider high-divider" *ngIf="index != taskList.length-1"> </div> -->\n\n      </div> \n\n  </ion-content>\n\n  <ion-footer  >\n\n    <ion-toolbar> \n\n            <button ion-button  round block  (click)="receiveReward()" [disabled]="!isCanReceive"> \n\n                {{\'SOCIAL_TASK_RECEIVE_ALL\' | translate}}\n\n            </button> \n\n    </ion-toolbar>\n\n  </ion-footer>\n\n'/*ion-inline-end:"F:\iproud2.5-pwa\src\pages\achievement\achieve-task-list\achieve-task-list.html"*/,
        }),
    ...
    return AchieveTaskListPage;
}());

//# sourceMappingURL=achieve-task-list.js.map
