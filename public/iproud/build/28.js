...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__my_follow__ = __webpack_require__(1234);
...
var MyFollowPageModule = (function () {
    function MyFollowPageModule() {
    }
    MyFollowPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [__WEBPACK_IMPORTED_MODULE_2__my_follow__["a" /* MyFollowPage */]],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["k" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__my_follow__["a" /* MyFollowPage */]),
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return MyFollowPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(13);
 ...
 */
var MyFollowPage = (function () {
    function MyFollowPage(navCtrl, clubProvider, popoverCtrl, navParams) {
        this.navCtrl = navCtrl;
        this.clubProvider = clubProvider;
        this.popoverCtrl = popoverCtrl;
        this.navParams = navParams;
        this.followTypeArray = ["用户", "社团"];
        this.followTypeSegment = this.followTypeArray[0];
    ...
    MyFollowPage.prototype.ionViewDidLoad = function () {
        this.getfollowUsers();
        this.getfollowClubs();
    };
    //用于关注的用户
    MyFollowPage.prototype.getfollowUsers = function (_event) {
        this.followUsers = [];
    ...
    MyFollowPage.prototype.doRefresh = function (_event) {
        _event.complete();
        this.getfollowUsers();
        this.getfollowClubs();
    };
    MyFollowPage.prototype.doInfinite = function (_event) {
        // this.clubProvider.getEvents(this.pageCount).subscribe(res => {
        //   this.hasMoreData = Math.floor(Math.random() * 10) % 3 != 1;
        //   this.followUsers.push.apply(this.followUsers, res);
        //   _event.complete();
        // });
    };
    //用于关注的社团
    MyFollowPage.prototype.getfollowClubs = function (_event) {
        this.followClubs = [];
        this.isDataLoading = true;
        // this.clubProvider.getEvents(this.pageCount).subscribe(res => {
        //   this.followClubs = res;
        //   this.isDataLoading = false;
        //   this.isDataEmpty = !res || res.length == 0;
        //   this.hasMoreData = true;
        //   this.followClubs.sort((a, b) => {
        //     return (
        //       new Date(b.eventTime).getTime() - new Date(a.eventTime).getTime()
        //     );
        //   });
    ...
    MyFollowPage.prototype.doRefresh1 = function (_event) {
        _event.complete();
        this.getfollowClubs();
    };
    MyFollowPage.prototype.doInfinite1 = function (_event) {
        // this.clubProvider.getEvents(this.pageCount).subscribe(res => {
        //   this.hasMoreData = Math.floor(Math.random() * 10) % 3 != 1;
        //   this.followClubs.push.apply(this.followClubs, res);
        //   _event.complete();
        // });
    };
    MyFollowPage.prototype.openClub = function (club) {
        this.navCtrl.push("ClubDetailPage", club);
    };
    MyFollowPage.prototype.openModal = function (myEvent) {
        var cb = {
            openContactAddPage: function () { },
            openContactGroupManage: function () { },
            openBlackListManage: function () { }
        };
        this.popover = this.popoverCtrl.create("ModalMorePage", {
            callback: cb
        });
    ...
    MyFollowPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: "page-my-follow",template:/*ion-inline-start:"F:\iproud2.5-pwa\src\pages\community\my\my-follow\my-follow.html"*/'<!--\n\n  Generated template for the MyFollowPage page.\n\n\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n\n  Ionic pages and navigation.\n\n-->\n\n<ion-header>\n\n  <ion-navbar>\n\n    <ion-title>my-follow</ion-title>\n\n  </ion-navbar>\n\n  <ion-searchbar\n\n    [(ngModel)]="searchText"\n\n    (ionInput)="getCurrentItems($event)"\n\n    (ionClear)="onClearFilter($event)"\n\n    placeholder="搜全部关注"\n\n  >\n\n  </ion-searchbar>\n\n  <ion-navbar>\n\n    <ion-segment\n\n      id="segment"\n\n      [(ngModel)]="followTypeSegment"\n\n      mode="md"\n\n      class="segment segment-ios segment-ios-primary ng-untouched ng-pristine ng-valid"\n\n    >\n\n      <ion-segment-button\n\n        *ngFor="let item of followTypeArray"\n\n        value="{{ item }}"\n\n      >\n\n        <span>{{ item }}</span>\n\n      </ion-segment-button>\n\n    </ion-segment>\n\n  </ion-navbar>\n\n\n\n  <ion-item no-lines>\n\n    <span item-start class="segment-title">全部关注</span>\n\n    <ion-icon item-end name="menu" (click)="openModal()"></ion-icon>\n\n  </ion-item>\n\n</ion-header>\n\n\n\n<ion-content>\n\n  <!--\n\n  <ion-grid>\n\n    <ion-row>\n\n      <ion-col col-3 text-center>\n\n        <button text-center class="button-item" (click)="openMyAssets()">\n\n          <ion-icon iproud name="community-follow" color="medium"></ion-icon>\n\n          <span class="description">最新关注</span>\n\n        </button>\n\n      </ion-col>\n\n      <ion-col col-3 text-center>\n\n        <button text-center class="button-item" (click)="openTaskList()">\n\n          <ion-icon iproud name="community-follow" color="medium"></ion-icon>\n\n          <span class="description">字母排序</span>\n\n        </button>\n\n      </ion-col>\n\n      <ion-col col-3 text-center>\n\n        <button text-center class="button-item" (click)="openAchievement()">\n\n          <ion-icon iproud name="community-follow" color="medium"></ion-icon>\n\n          <span class="description">最新发博</span>\n\n        </button>\n\n      </ion-col>\n\n      <ion-col col-3 text-center>\n\n        <button text-center class="button-item" (click)="openTerms()">\n\n          <ion-icon iproud name="community-follow" color="medium"></ion-icon>\n\n          <span class="description">分类排序</span>\n\n        </button>\n\n      </ion-col>\n\n    </ion-row>\n\n  </ion-grid>\n\n  -->\n\n\n\n  <div [ngSwitch]="followTypeSegment">\n\n    <!--关注的用户-->\n\n    <div *ngSwitchCase="\'用户\'" class="segment-user">\n\n      <ion-refresher (ionRefresh)="doRefresh($event)">\n\n        <ion-refresher-content pullingIcon="arrow-dropdown">\n\n        </ion-refresher-content>\n\n      </ion-refresher>\n\n\n\n      <iproud-load-data\n\n        [isDataEmpty]="isDataEmpty"\n\n        [isDataLoading]="isDataLoading"\n\n      >\n\n      </iproud-load-data>\n\n\n\n      <ion-list *ngIf="followUsers && followUsers.length > 0">\n\n        <ion-item *ngFor="let item of followUsers">\n\n          <ion-avatar item-start>\n\n            <img [src]="item.eventImage" />\n\n          </ion-avatar>\n\n          <h2>{{ item.clubName }}</h2>\n\n          <p>{{ item.title }}</p>\n\n          <ion-note item-end>\n\n            <button ion-button small outline>已关注</button>\n\n          </ion-note>\n\n        </ion-item>\n\n      </ion-list>\n\n\n\n      <ion-infinite-scroll\n\n        *ngIf="hasMoreData"\n\n        (ionInfinite)="doInfinite($event)"\n\n      >\n\n        <ion-infinite-scroll-content\n\n          aria-posinset="button"\n\n          loadingSpinner="bubbles"\n\n        >\n\n        </ion-infinite-scroll-content>\n\n      </ion-infinite-scroll>\n\n    </div>\n\n\n\n    <!--关注的社团-->\n\n    <div *ngSwitchCase="\'社团\'" class="segment-club">\n\n      <ion-refresher (ionRefresh)="doRefresh1($event)">\n\n        <ion-refresher-content pullingIcon="arrow-dropdown">\n\n        </ion-refresher-content>\n\n      </ion-refresher>\n\n\n\n      <iproud-load-data\n\n        [isDataEmpty]="isDataEmpty"\n\n        [isDataLoading]="isDataLoading"\n\n      >\n\n      </iproud-load-data>\n\n\n\n      <ion-list *ngIf="followClubs && followClubs.length > 0">\n\n        <ion-item *ngFor="let item of followClubs">\n\n          <ion-avatar item-start>\n\n            <img [src]="item.eventImage" />\n\n          </ion-avatar>\n\n          <h2>{{ item.clubName }}</h2>\n\n          <p>{{ item.eventPlace }}</p>\n\n          <ion-note item-end>\n\n            <button ion-button small outline class>已关注</button>\n\n          </ion-note>\n\n        </ion-item>\n\n      </ion-list>\n\n\n\n      <ion-infinite-scroll\n\n        *ngIf="hasMoreData"\n\n        (ionInfinite)="doInfinite1($event)"\n\n      >\n\n        <ion-infinite-scroll-content\n\n          aria-posinset="button"\n\n          loadingSpinner="bubbles"\n\n        >\n\n        </ion-infinite-scroll-content>\n\n      </ion-infinite-scroll>\n\n    </div>\n\n  </div>\n\n</ion-content>\n\n'/*ion-inline-end:"F:\iproud2.5-pwa\src\pages\community\my\my-follow\my-follow.html"*/
        }),
