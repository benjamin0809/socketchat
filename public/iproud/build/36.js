...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AchieveItemPageModule", function() { return AchieveItemPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__achieve_item__ = __webpack_require__(1181);
...
var AchieveItemPageModule = (function () {
    function AchieveItemPageModule() {
    }
    AchieveItemPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__achieve_item__["a" /* AchieveItemPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_4__ngx_translate_core__["b" /* TranslateModule */],
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["k" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__achieve_item__["a" /* AchieveItemPage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */]
            ],
        })
    ], AchieveItemPageModule);
    return AchieveItemPageModule;
}());

//# sourceMappingURL=achieve-item.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return AchieveItemPage; });
...
/**
 * Generated class for the AchieveItemPage page.
 *
 * See https://ionicframework.com/docs/components/#navigation for more info on
 * Ionic pages and navigation.
 */
var AchieveItemPage = (function () {
    function AchieveItemPage(navCtrl, navParams, view, element, events, cd, handleProvider, preload, session) {
        this.navCtrl = navCtrl;
        ...
        this.Item['displayName'] = this.session.user.employeeInfo ? this.session.user.employeeInfo.employeeName : this.session.user.nickName;
    }
    AchieveItemPage.prototype.ionViewDidLoad = function () {
    };
    AchieveItemPage.prototype.ionViewDidEnter = function () {
        this.isShowCloseButton = true;
    };
    AchieveItemPage.prototype.ionViewWillEnter = function () {
        this._setBackgroundToBlur(3);
    };
    AchieveItemPage.prototype.ionViewWillLeave = function () {
        this._setBackgroundToBlur(0);
    };
    AchieveItemPage.prototype._setBackgroundToBlur = function (blur) {
        if (blur === void 0) { blur = 0; }
        var rootTabs = document.getElementById('rootTabs');
        rootTabs.style.filter = "blur(" + blur + "px)";
    };
    AchieveItemPage.prototype.close = function () {
        // this.view.dismiss()
        this.events.publish('backbutton:onclick');
    };
    AchieveItemPage.prototype.shareMedal = function (_event) {
        var _this = this;
        (_event || event).stopPropagation();
        this.isSharing = true;
        this.cd.detectChanges();
        setTimeout(function () {
            __WEBPACK_IMPORTED_MODULE_3__services_utility__["a" /* Utility */].captureWebPage(_this.element.nativeElement).subscribe(function (res) {
                console.log(res);
                _this.isSharing = false;
                _this.openSharePage(res.result);
            }, function (err) {
                _this.handleProvider.generate('captureWebPage', -1, err);
            });
        }, 100);
    };
    /**
   * 分享
   */
    AchieveItemPage.prototype.openSharePage = function (imageDataURL) {
        var shareMessage = {
            title: this.Item.name,
            description: this.Item.description,
            thumb: "www/assets/imgs/logo.png",
            resource: imageDataURL //图片url或网页url
        };
    ...
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_5__angular_core__["ViewChild"])('mainTabs'),
        __metadata("design:type", Object)
    ], AchieveItemPage.prototype, "tabs", void 0);
    AchieveItemPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_5__angular_core__["Component"])({
            selector: 'page-achieve-item',template:/*ion-inline-start:"F:\iproud2.5-pwa\src\pages\achievement\achieve-item\achieve-item.html"*/' <ion-content [ngClass]="{\'sharing-bg\': isSharing}" (click)="close()">   \n\n  <div class="close-button" >\n\n      <!-- <ion-icon  *ngIf="isShowCloseButton && !isSharing"  ios="ios-arrow-back" md="md-arrow-back"></ion-icon> -->\n\n  </div> \n\n  <div class="medal-container">\n\n\n\n    <div class="medal" [ngStyle]="{\'background-color\': !Item?.isTake ? \'#8d8d8d\' : \'#FFBF00\'}">\n\n        <!-- <img-lazy-load [src]="Item?.icon"></img-lazy-load>   -->\n\n        <img-lazy-load [src]="Item?.iconUrl"></img-lazy-load>  \n\n    </div>\n\n    \n\n  </div>\n\n  <div class="text blessing"> \n\n    <span *ngIf="Item?.isTake"> {{\'SOCIAL_ACHIEVEMENT_ITEM_GOT\' | translate}}</span>\n\n    <span *ngIf="!Item?.isTake"> {{\'SOCIAL_ACHIEVEMENT_ITEM_NO_GOT\' | translate}}</span> \n\n  </div>\n\n\n\n  <div class="text medal-name">  \n\n        <span class="assist-line"></span>\n\n        <span>{{Item?.name}}</span>\n\n        <span class="assist-line"></span>  \n\n    </div>\n\n\n\n    <div class="text description"> \n\n        {{Item?.description}}\n\n      </div>\n\n\n\n      <!--*ngIf="Item?.isTake" -->\n\n      <div *ngIf="Item?.isTake"  text-center class="share-container">\n\n        <button ion-button outline round small color="medium" (click)="shareMedal($event)" *ngIf="!isSharing">{{\'SOCIAL_ACHIEVEMENT_ITEM_SHARE_BUTTON\' | translate}}</button>\n\n        <div class="award-date">{{Item?.getTime}}{{\'SOCIAL_ACHIEVEMENT_ITEM_PRESENTEDTO\' | translate}}</div>\n\n        <div class="award-winner">{{Item?.displayName}}</div>\n\n      </div>\n\n</ion-content>\n\n'/*ion-inline-end:"F:\iproud2.5-pwa\src\pages\achievement\achieve-item\achieve-item.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_4_ionic_angular__["p" /* NavController */],
            ...
            __WEBPACK_IMPORTED_MODULE_4_ionic_angular__["g" /* Events */],
            __WEBPACK_IMPORTED_MODULE_5__angular_core__["ChangeDetectorRef"],
    ...
    return AchieveItemPage;
}());

//# sourceMappingURL=achieve-item.js.map
