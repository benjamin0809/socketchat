...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MyPublicationPageModule", function() { return MyPublicationPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__my_publication__ = __webpack_require__(1235);
...
var MyPublicationPageModule = (function () {
    function MyPublicationPageModule() {
    }
    MyPublicationPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [__WEBPACK_IMPORTED_MODULE_2__my_publication__["a" /* MyPublicationPage */]],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["k" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__my_publication__["a" /* MyPublicationPage */]),
                __WEBPACK_IMPORTED_MODULE_3__ngx_translate_core__["b" /* TranslateModule */].forChild(),
                __WEBPACK_IMPORTED_MODULE_4__components_components_module__["a" /* ComponentsModule */]
            ]
        })
    ], MyPublicationPageModule);
    return MyPublicationPageModule;
}());

//# sourceMappingURL=my-publication.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return MyPublicationPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(13);
 ...
 */
var MyPublicationPage = (function () {
    function MyPublicationPage(navCtrl, clubProvider, session, navParams) {
        this.navCtrl = navCtrl;
    ...
    MyPublicationPage.prototype.ionViewDidLoad = function () {
        this.getMyPublications();
    };
    MyPublicationPage.prototype.getMyPublications = function (_event) {
        this.myPublications = [];
        this.isDataLoading = true;
        // this.clubProvider.getEvents(this.pageCount).subscribe(res => {
        //   this.myPublications = res;
        //   this.isDataLoading = false;
        //   this.isDataEmpty = !res || res.length == 0;
        //   this.hasMoreData = true;
        //   this.myPublications.sort((a, b) => {
        //     return (
    ...
    MyPublicationPage.prototype.doRefresh = function (_event) {
        _event.complete();
        this.getMyPublications();
    };
    MyPublicationPage.prototype.doInfinite = function (_event) {
        // this.clubProvider.getEvents(this.pageCount).subscribe(res => {
        //   this.hasMoreData = Math.floor(Math.random() * 10) % 3 != 1;
        //   this.myPublications.push.apply(this.myPublications, res);
        //   _event.complete();
        // });
    };
    MyPublicationPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: "page-my-publication",template:/*ion-inline-start:"F:\iproud2.5-pwa\src\pages\community\my\my-publication\my-publication.html"*/'<!--\n\n  Generated template for the MyPublicationPage page.\n\n\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n\n  Ionic pages and navigation.\n\n-->\n\n<ion-header>\n\n  <ion-navbar>\n\n    <ion-title>my-publication</ion-title>\n\n  </ion-navbar>\n\n\n\n  <ion-item no-lines>\n\n    <span item-start class="segment-title">全部(24)</span>\n\n    <ion-icon name="menu" item-end></ion-icon>\n\n  </ion-item>\n\n</ion-header>\n\n\n\n<ion-content>\n\n  <ion-refresher (ionRefresh)="doRefresh($event)">\n\n    <ion-refresher-content pullingIcon="arrow-dropdown">\n\n    </ion-refresher-content>\n\n  </ion-refresher>\n\n\n\n  <iproud-load-data [isDataEmpty]="isDataEmpty" [isDataLoading]="isDataLoading">\n\n  </iproud-load-data>\n\n\n\n  <ion-list>\n\n    <ion-item *ngFor="let item of myPublications">\n\n      <ion-row>\n\n        <ion-col col-2>\n\n          <ion-row><h2>10</h2></ion-row>\n\n          <ion-row><p>19/05</p></ion-row>\n\n        </ion-col>\n\n        <ion-col col-3>\n\n          <ion-row><img [src]="item.eventImage"/></ion-row>\n\n          <ion-row>\n\n            <p>{{ item.clubName }}</p>\n\n          </ion-row>\n\n          <ion-row><p>0赞 0评论</p></ion-row>\n\n        </ion-col>\n\n        <ion-col col-7>\n\n          <h4>{{ item.eventPlace }}</h4>\n\n        </ion-col>\n\n      </ion-row>\n\n    </ion-item>\n\n  </ion-list>\n\n\n\n  <ion-infinite-scroll *ngIf="hasMoreData" (ionInfinite)="doInfinite($event)">\n\n    <ion-infinite-scroll-content\n\n      aria-posinset="button"\n\n      loadingSpinner="bubbles"\n\n    >\n\n    </ion-infinite-scroll-content>\n\n  </ion-infinite-scroll>\n\n</ion-content>\n\n'/*ion-inline-end:"F:\iproud2.5-pwa\src\pages\community\my\my-publication\my-publication.html"*/
        }),
    ...
    return MyPublicationPage;
}());

//# sourceMappingURL=my-publication.js.map
