...
class FileDao{
    ...
    insertFile(fileEntity){
        ...
        let params = []
        let columns = [
            { code: "id", default : +new Date() },
            { code: "masterid", default : null},
            { code: "filename", default :null},
            { code: "path", default : null },
            { code: "fullpath", default : null },
            { code: "filetype", default : null },
            { code: "sourceUrl", default : null},
            { code: "createTime", default : DateUtils.getCurrentTime() },
            { code: "modifiedTime", default : null}
        ]
